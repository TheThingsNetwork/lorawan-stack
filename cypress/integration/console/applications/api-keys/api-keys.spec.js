...
describe('Application API keys', () => {
  ...
  it('succeed adding new api key', () => {
    ...
    cy.findByTestId('modal-window')
      .should('be.visible')
      .within(() => {
        cy.findByText('Please copy newly created API key', { selector: 'h1' }).should('be.visible')
