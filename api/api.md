...
- [File `lorawan-stack/api/packetbrokeragent.proto`](#lorawan-stack/api/packetbrokeragent.proto)
  ...
  - [Message `ListHomeNetworksRoutingPoliciesRequest`](#ttn.lorawan.v3.ListHomeNetworksRoutingPoliciesRequest)
...
### <a name="ttn.lorawan.v3.ListHomeNetworksRoutingPoliciesRequest">Message `ListHomeNetworksRoutingPoliciesRequest`</a>
...
| `offset` | [`uint32`](#uint32) |  | Number of items to skip. |
| `limit` | [`uint32`](#uint32) |  | Limit the number of items. If 0, use the server's default. The actual limit may be capped by the server. |
...
| `GetForwarderDefaultRoutingPolicy` | [`.google.protobuf.Empty`](#google.protobuf.Empty) | [`PacketBrokerDefaultRoutingPolicy`](#ttn.lorawan.v3.PacketBrokerDefaultRoutingPolicy) | Get the default routing policy. Getting routing policies requires administrative access. |
| `SetForwarderDefaultRoutingPolicy` | [`SetPacketBrokerDefaultRoutingPolicyRequest`](#ttn.lorawan.v3.SetPacketBrokerDefaultRoutingPolicyRequest) | [`.google.protobuf.Empty`](#google.protobuf.Empty) | Set the default routing policy. Setting routing policies requires administrative access. |
| `DeleteForwarderDefaultRoutingPolicy` | [`.google.protobuf.Empty`](#google.protobuf.Empty) | [`.google.protobuf.Empty`](#google.protobuf.Empty) | Deletes the default routing policy. Deleting routing policies requires administrative access. |
...
| `GetForwarderRoutingPolicy` | [`PacketBrokerNetworkIdentifier`](#ttn.lorawan.v3.PacketBrokerNetworkIdentifier) | [`PacketBrokerRoutingPolicy`](#ttn.lorawan.v3.PacketBrokerRoutingPolicy) | Get the routing policy for the given Home Network. Getting routing policies requires administrative access. |
| `SetForwarderRoutingPolicy` | [`SetPacketBrokerRoutingPolicyRequest`](#ttn.lorawan.v3.SetPacketBrokerRoutingPolicyRequest) | [`PacketBrokerRoutingPolicy`](#ttn.lorawan.v3.PacketBrokerRoutingPolicy) | Set the routing policy for the given Home Network. Setting routing policies requires administrative access. |
| `DeleteForwarderRoutingPolicy` | [`PacketBrokerNetworkIdentifier`](#ttn.lorawan.v3.PacketBrokerNetworkIdentifier) | [`.google.protobuf.Empty`](#google.protobuf.Empty) | Delete the routing policy for the given Home Network. Deleting routing policies reuqires administrative access. |
...
| `ListHomeNetworkRoutingPolicies` | [`ListHomeNetworksRoutingPoliciesRequest`](#ttn.lorawan.v3.ListHomeNetworksRoutingPoliciesRequest) | [`PacketBrokerRoutingPolicies`](#ttn.lorawan.v3.PacketBrokerRoutingPolicies) | List the routing policies that Forwarders configured with Packet Broker Agent as Home Network. Listing routing policies requires administrative access. |
...
| `GetForwarderDefaultRoutingPolicy` | `GET` | `/api/v3/pba/forwarder/default-policy` |  |
| `SetForwarderDefaultRoutingPolicy` | `PUT` | `/api/v3/pba/forwarder/default-policy` | `*` |
| `SetForwarderDefaultRoutingPolicy` | `POST` | `/api/v3/pba/forwarder/default-policy` | `*` |
| `DeleteForwarderDefaultRoutingPolicy` | `DELETE` | `/api/v3/pba/forwarder/default-policy` |  |
| `ListForwarderRoutingPolicies` | `GET` | `/api/v3/pba/forwarder/policies` |  |
| `GetForwarderRoutingPolicy` | `GET` | `/api/v3/pba/forwarder/policies/{net_id}` |  |
| `GetForwarderRoutingPolicy` | `GET` | `/api/v3/pba/forwarder/policies/{net_id}/{tenant_id}` |  |
| `SetForwarderRoutingPolicy` | `PUT` | `/api/v3/pba/forwarder/policies/{home_network_id.net_id}` | `*` |
| `SetForwarderRoutingPolicy` | `POST` | `/api/v3/pba/forwarder/policies/{home_network_id.net_id}` | `*` |
| `SetForwarderRoutingPolicy` | `PUT` | `/api/v3/pba/forwarder/policies/{home_network_id.net_id}/{home_network_id.tenant_id}` | `*` |
| `SetForwarderRoutingPolicy` | `POST` | `/api/v3/pba/forwarder/policies/{home_network_id.net_id}/{home_network_id.tenant_id}` | `*` |
| `DeleteForwarderRoutingPolicy` | `DELETE` | `/api/v3/pba/forwarder/policies/{net_id}` |  |
| `DeleteForwarderRoutingPolicy` | `DELETE` | `/api/v3/pba/forwarder/policies/{net_id}/{tenant_id}` |  |
| `ListHomeNetworks` | `GET` | `/api/v3/pba/forwarder/home-networks` |  |
| `ListHomeNetworkRoutingPolicies` | `GET` | `/api/v3/pba/home-network/policies` |  |
