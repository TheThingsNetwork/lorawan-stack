...
| list | [ProvisionEndDevicesRequest.IdentifiersList](#ttn.lorawan.v3.ProvisionEndDevicesRequest.IdentifiersList) |  | List of device identifiers that will be provisioned. The device identifiers must contain application_ids, device_id, join_eui and dev_eui. The application_ids must equal the provision request&#39;s application_ids. The number of entries in data must match the number of given identifiers. |
| range | [ProvisionEndDevicesRequest.IdentifiersRange](#ttn.lorawan.v3.ProvisionEndDevicesRequest.IdentifiersRange) |  | Provision devices in a range. The device_id will be generated by the provisioner depending on the vendor-specific data. The dev_eui will be issued from the given from_dev_eui. |
