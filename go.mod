...
require (
	...
	go.packetbroker.org/api/iam v1.1.2-tts
	go.packetbroker.org/api/iam/v2 v2.0.3-tts
	go.packetbroker.org/api/routing v1.1.3-tts
	go.packetbroker.org/api/v3 v3.3.2-tts
