...
// New versions drop support for AWS SDK v1
replace gocloud.dev => gocloud.dev v0.41.0

replace gocloud.dev/pubsub/natspubsub => gocloud.dev/pubsub/natspubsub v0.41.0
...
require (
	...
	go.thethings.network/lorawan-stack-legacy/v2 v2.1.1
