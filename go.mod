...
// See https://github.com/grpc-ecosystem/grpc-gateway/pull/3725
replace github.com/grpc-ecosystem/grpc-gateway/v2 => github.com/adriansmares/grpc-gateway/v2 v2.0.0-20231107141503-82f9c7648913
