...
// Package commands implements the commands for the ttn-lw-gateway-server binary.
package commands
...
var (
	...
	Root = &cobra.Command{
		...
		SilenceErrors: true,
		SilenceUsage:  true,
		Short:         "The Things Network Gateway Server for LoRaWAN",
