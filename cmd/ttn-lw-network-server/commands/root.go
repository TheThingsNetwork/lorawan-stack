...
// Package commands implements the commands for the ttn-lw-network-server binary.
package commands
...
var (
	...
	Root = &cobra.Command{
		...
		SilenceErrors: true,
		SilenceUsage:  true,
		Short:         "The Things Network Network Server for LoRaWAN",
