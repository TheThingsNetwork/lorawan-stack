...
// DefaultAccountAppPublicURL is the default public URL where Account app and
// OAuth provider are served.
var DefaultAccountAppPublicURL = DefaultPublicURL + "/account"
