...
In order to receive uplinks and send downlinks to your device, you must first link the application server to the network server. In order to do this, first create an API key for the application server:
