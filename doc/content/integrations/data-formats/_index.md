...
```javascript
{
  ...
  "uplink_message" : {
    ...
    "settings": {                            // Settings for the transmission
      ...
      "timestamp": 2463457000,               // Timestamp of the gateway concentrator when the accepted uplink message has been received
      "time": "2020-02-12T15:15:45.787Z"     // ISO 8601 UTC timestamp at which the accepted uplink has been received by the gateway
    },
