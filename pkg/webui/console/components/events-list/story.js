...
import DeviceEvents from './application/device'

const deviceEvents = [
  {
    name: 'events.stream.start',
    time: '2020-04-23T09:54:46.294785768Z',
    identifiers: [
      {
        device_ids: {
    ...
    data: {
      '@type': 'type.googleapis.com/ttn.lorawan.v3.StreamEventsRequest',
      identifiers: [
        {
          device_ids: {
            device_id: 'test-dev-c',
    ...
    correlation_ids: ['rpc:/ttn.lorawan.v3.Events/Stream:01E6K7C2VRXDJT65BK8CCAWMSY'],
    origin: 'cobalt',
    visibility: {},
  },
  {
...
const events = [
  ...deviceEvents,
  {
    ...
    name: 'events.stream.start',
    time: '2020-04-23T09:39:03.134034132Z',
  },
  {
    identifiers: [{ application_ids: { application_id: 'test-app2' } }],
...
storiesOf('Events/Application', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <ApplicationEvents.Widget events={events} appId="test-app2" />
  </div>
))
...
storiesOf('Events/Gateway', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <GatewayEvents.Widget events={gatewayEvents} gtwId="test-gtw-id" />
  </div>
))
storiesOf('Events/Organization', module).add('Default', () => (
  <OrganizationEvents
    orgId="test-org-id"
    events={organizationEents}
...
storiesOf('Events/Organization', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <OrganizationEvents.Widget events={organizationEents} orgId="test-org-id" />
  </div>
))
...
storiesOf('Events/Device', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <DeviceEvents.Widget events={deviceEvents} deviceId="test-dev-c" />
  </div>
))
