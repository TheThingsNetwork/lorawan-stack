...
export default defineMessages({
  ...
  nsServerAddressDescription: 'The address of the device\'s Network Server',
  asServerAddressDescription: 'The address of the device\'s Application Server',
  jsServerAddressDescription: 'The address of the device\'s Join Server',
