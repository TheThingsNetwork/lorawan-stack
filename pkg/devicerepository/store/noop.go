...
func (*NoopStore) GetUplinkDecoder(GetCodecRequest) (*ttnpb.MessagePayloadFormatter, error) {
	return nil, errNotFound.New()
}

// GetDownlinkDecoder retrieves the codec for decoding downlink messages.
func (*NoopStore) GetDownlinkDecoder(GetCodecRequest) (*ttnpb.MessagePayloadFormatter, error) {
	return nil, errNotFound.New()
}

// GetDownlinkEncoder retrieves the codec for encoding downlink messages.
func (*NoopStore) GetDownlinkEncoder(GetCodecRequest) (*ttnpb.MessagePayloadFormatter, error) {
	return nil, errNotFound.New()
}
