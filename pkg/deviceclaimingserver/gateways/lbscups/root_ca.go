...
// Package lbscups provides functions to use The Things Gateway Controller LBS CUPS server.
package lbscups
...
var (
	errDialGatewayServer      = errors.DefineAborted("dial_gateway_server", "dial Gateway Server `{address}`")
