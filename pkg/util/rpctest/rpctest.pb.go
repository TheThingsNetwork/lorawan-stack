...
// source: go.thethings.network/lorawan-stack/v3/pkg/rpctest/rpctest.proto

/*
Package rpctest is a generated protocol buffer package.

It is generated from these files:
	go.thethings.network/lorawan-stack/v3/pkg/rpctest/rpctest.proto
...
var _FooBar_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "go.thethings.network/lorawan-stack/v3/pkg/rpctest/rpctest.proto",
}
...
func init() {
	proto.RegisterFile("go.thethings.network/lorawan-stack/v3/pkg/rpctest/rpctest.proto", fileDescriptorRpctest)
}
func init() {
	golang_proto.RegisterFile("go.thethings.network/lorawan-stack/v3/pkg/rpctest/rpctest.proto", fileDescriptorRpctest)
}
