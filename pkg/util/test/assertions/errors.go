...
// ShouldDescribe takes as argument an Error and an ErrDescriptor. If the arguments are
...
// ShouldNotDescribe takes as argument an Error and an ErrDescriptor. If the Error was
