...
var (
	...
	// DescribeError asserts that the errors.Error was generated by a given errors.ErrDescriptor.
	DescribeError = testassertions.ShouldDescribeError
	// NotDescribeError asserts that the errors.Error was not generated by a given errors.ErrDescriptor.
	NotDescribeError = testassertions.ShouldNotDescribeError
