...
// ShouldHaveParentContext takes as argument a context.Context and context.Context. If the arguments are valid and the Error was generated by this ErrDescriptor, the function returns an empty string. Otherwise, it returns a string describing the error.
