...
func TestTokenCredentials(t *testing.T) {
	for _, tc := range []struct {
	...
	}{
		{
			...
			Token:    "token\n",
			Expected: []byte{0x4C, 0x45, 0x54, 0x53, 0x20, 0x4E, 0x4F, 0x54, 0x20, 0x45, 0x4E, 0x43, 0x52, 0x59, 0x50, 0x54, 0x0, 0x0, 0x0, 0x0, 0x41, 0x75, 0x74, 0x68, 0x6F, 0x72, 0x69, 0x7A, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x3A, 0x20, 0x42, 0x65, 0x61, 0x72, 0x65, 0x72, 0x20, 0x74, 0x6F, 0x6B, 0x65, 0x6E, 0xD, 0xA},
		},
		{
			Name:     "Valid",
			Token:    "token",
