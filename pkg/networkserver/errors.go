...
var (
	...
	errInvalidFNwkSIntKey        = errors.DefineInvalidArgument("invalid_f_nwk_s_int_key", "invalid FNwkSIntKey specified")
	errInvalidNwkSEncKey         = errors.DefineInvalidArgument("invalid_nwk_s_enc_key", "invalid NwkSEncKey specified")
	...
	errInvalidSNwkSIntKey        = errors.DefineInvalidArgument("invalid_s_nwk_s_int_key", "invalid SNwkSIntKey specified")
	...
	errNoMACSettings             = errors.DefineInvalidArgument("no_mac_settings", "no mac settings specified")
