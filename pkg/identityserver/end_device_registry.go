...
func validateEndDeviceCAC(cac *ttnpb.EndDeviceClaimAuthenticationCode) error {
	if cac.Secret == nil {
		return errEndDeviceCAC.New()
	}
	validFrom, validTo := ttnpb.StdTime(cac.ValidFrom), ttnpb.StdTime(cac.ValidTo)
