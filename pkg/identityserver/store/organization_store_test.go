...
func TestOrganizationStore(t *testing.T) {
	...
	WithDB(t, func(t *testing.T, db *gorm.DB) {
		db.AutoMigrate(&Account{}, &Organization{}, &Attribute{}, &ContactInfo{})
		...
		got, err := store.GetOrganization(ctx, &ttnpb.OrganizationIdentifiers{OrganizationID: "foo"}, &types.FieldMask{Paths: []string{"name", "attributes", "contact_info"}})
		a.So(err, should.BeNil)
