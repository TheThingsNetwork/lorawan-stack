...
func TestOrganizationStore(t *testing.T) {
	...
	WithDB(t, func(t *testing.T, db *gorm.DB) {
		db.AutoMigrate(&Account{}, &Organization{})
		...
		got, err := store.GetOrganization(ctx, &ttnpb.OrganizationIdentifiers{OrganizationID: "foo"}, &types.FieldMask{Paths: []string{"name"}})
		a.So(err, should.BeNil)
