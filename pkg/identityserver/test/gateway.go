...
func ShouldBeGatewayIgnoringAutoFields(actual interface{}, expected ...interface{}) string {
	...
	return all(
		...
		assertions.ShouldResemble(a.AntennaType, b.AntennaType),
		assertions.ShouldResemble(a.AntennaModel, b.AntennaModel),
		assertions.ShouldResemble(a.AntennaPlacement, b.AntennaPlacement),
		assertions.ShouldResemble(a.AntennaAltitude, b.AntennaAltitude),
		assertions.ShouldResemble(a.AntennaLocation, b.AntennaLocation),
