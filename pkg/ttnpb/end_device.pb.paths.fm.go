...
var EndDeviceClaimAuthenticationCodeFieldPathsNested = []string{
	"secret",
	"secret.key_id",
	"secret.value",
	"valid_from",
...
var EndDeviceClaimAuthenticationCodeFieldPathsTopLevel = []string{
	"secret",
	"valid_from",
	"valid_to",
}
var EndDeviceFieldPathsNested = []string{
	...
	"downlink_margin",
	"end_device_cac",
	"end_device_cac.secret",
	"end_device_cac.secret.key_id",
	"end_device_cac.secret.value",
	"end_device_cac.valid_from",
	"end_device_cac.valid_to",
	"formatters",
