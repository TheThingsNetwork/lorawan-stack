...
func TestCombinedIdentifiersProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestCombinedIdentifiersMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, false)
	size := p.Size()
...
func BenchmarkCombinedIdentifiersProtoUnmarshal(b *testing.B) {
	...
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := proto.Marshal(NewPopulatedCombinedIdentifiers(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestCombinedIdentifiersJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, true)
	marshaler := jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestCombinedIdentifiersProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, true)
	dAtA := proto.MarshalTextString(p)
...
func TestCombinedIdentifiersProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, true)
	dAtA := proto.CompactTextString(p)
...
func TestCombinedIdentifiersVerboseEqual(t *testing.T) {
	popr := rand.New(rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedCombinedIdentifiers(popr, false)
	dAtA, err := proto.Marshal(p)
	if err != nil {
...
func TestCombinedIdentifiersSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := rand.New(rand.NewSource(seed))
	p := NewPopulatedCombinedIdentifiers(popr, true)
	size2 := proto.Size(p)
