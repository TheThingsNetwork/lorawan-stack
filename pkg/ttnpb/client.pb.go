...
type ClientMask struct {
	...
	RedirectURI bool `protobuf:"varint,2,opt,name=redirect_uri,json=redirectUri,proto3" json:"redirect_uri,omitempty"`
	Rights      bool `protobuf:"varint,6,opt,name=rights,proto3" json:"rights,omitempty"`
}

func (m *ClientMask) Reset()                    { *m = ClientMask{} }
func (m *ClientMask) String() string            { return proto.CompactTextString(m) }
func (*ClientMask) ProtoMessage()               {}
func (*ClientMask) Descriptor() ([]byte, []int) { return fileDescriptorClient, []int{1} }

func (m *ClientMask) GetDescription() bool {
	if m != nil {
		return m.Description
	}
	return false
...
func (m *ClientMask) GetRedirectURI() bool {
	if m != nil {
		return m.RedirectURI
	}
	return false
...
func (m *ClientMask) GetRights() bool {
	if m != nil {
		return m.Rights
	}
	return false
...
func init() {
	...
	proto.RegisterType((*ClientMask)(nil), "ttn.v3.ClientMask")
	golang_proto.RegisterType((*ClientMask)(nil), "ttn.v3.ClientMask")
...
func (this *ClientMask) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	that1, ok := that.(*ClientMask)
	if !ok {
		that2, ok := that.(ClientMask)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *ClientMask")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *ClientMask but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *ClientMask but is not nil && this == nil")
	}
	if this.Description != that1.Description {
		return fmt.Errorf("Description this(%v) Not Equal that(%v)", this.Description, that1.Description)
	}
...
func (this *ClientMask) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
...
func (m *ClientMask) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ClientMask) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ClientMask) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClientMask: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClientMask: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorClient = []byte{
	...
	,
}
