...
// MarshalProtoJSON marshals the GatewayConnectionStatsEntry message to JSON.
func (x *GatewayConnectionStatsEntry) MarshalProtoJSON(s *jsonplugin.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	...
	if x.GatewayConnectionStats != nil || s.HasField("gateway_connection_stats") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("gateway_connection_stats")
		x.GatewayConnectionStats.MarshalProtoJSON(s.WithField("gateway_connection_stats"))
	}
	s.WriteObjectEnd()
}

// MarshalJSON marshals the GatewayConnectionStatsEntry to JSON.
func (x GatewayConnectionStatsEntry) MarshalJSON() ([]byte, error) {
	return jsonplugin.DefaultMarshalerConfig.Marshal(&x)
}

// UnmarshalProtoJSON unmarshals the GatewayConnectionStatsEntry message from JSON.
func (x *GatewayConnectionStatsEntry) UnmarshalProtoJSON(s *jsonplugin.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "gateway_connection_stats", "gatewayConnectionStats":
			...
			x.GatewayConnectionStats = &GatewayConnectionStats{}
			x.GatewayConnectionStats.UnmarshalProtoJSON(s.WithField("gateway_connection_stats", true))
		}
	})
}

// UnmarshalJSON unmarshals the GatewayConnectionStatsEntry from JSON.
func (x *GatewayConnectionStatsEntry) UnmarshalJSON(b []byte) error {
	return jsonplugin.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
