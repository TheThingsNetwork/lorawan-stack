...
uplink-dwell-time: true`
	...
	a.So(fp.LBT, should.BeNil)
	a.So(fp.UplinkDwellTime, should.BeTrue)
	a.So(fp.DownlinkDwellTime, should.BeFalse)
}
...
tx-timeoff-air:
  duration: 90ms`
	...
	a.So(fp.UplinkDwellTime, should.BeTrue)
	a.So(fp.DownlinkDwellTime, should.BeTrue)
}
