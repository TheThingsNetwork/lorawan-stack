...
var fileDescriptor_8c9d796b7f7ca235 = []byte{
	...
	,
}
...
func (m *Secret) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Blob) > 0 {
		i -= len(m.Blob)
		copy(dAtA[i:], m.Blob)
		i = encodeVarintSecrets(dAtA, i, uint64(len(m.Blob)))
		i--
		dAtA[i] = 0xa
	}
...
func NewPopulatedSecret(r randySecrets, easy bool) *Secret {
	this := &Secret{}
	v1 := r.Intn(100)
	this.Blob = make([]byte, v1)
	for i := 0; i < v1; i++ {
		this.Blob[i] = byte(r.Intn(256))
	}
