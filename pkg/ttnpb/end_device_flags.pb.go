...
func (m *Session) SetFromFlags(flags *pflag.FlagSet, prefix string) (paths []string, err error) {
	...
	if val, changed, err := flagsplugin.GetTimestamp(flags, flagsplugin.Prefix("started_at", prefix)); err != nil {
		...
		m.StartedAt = gogo.SetTimestamp(val)
		paths = append(paths, flagsplugin.Prefix("started_at", prefix))
	}
...
func AddSetFlagsForMACSettings(flags *pflag.FlagSet, prefix string, hidden bool) {
	...
	flags.AddFlag(flagsplugin.NewFloat32Flag(flagsplugin.Prefix("adr-margin", prefix), "", flagsplugin.WithHidden(true)))
	...
	flags.AddFlag(flagsplugin.NewUint32Flag(flagsplugin.Prefix("status-count-periodicity", prefix), "", flagsplugin.WithHidden(true)))
...
func (m *MACState_JoinAccept) SetFromFlags(flags *pflag.FlagSet, prefix string) (paths []string, err error) {
	...
	if val, changed, err := types.GetNetID(flags, flagsplugin.Prefix("net_id", prefix)); err != nil {
		return nil, err
	} else if changed {
		m.NetId = val
		paths = append(paths, flagsplugin.Prefix("net_id", prefix))
...
func AddSetFlagsForEndDevice(flags *pflag.FlagSet, prefix string, hidden bool) {
	...
	flags.AddFlag(flagsplugin.NewFloat32Flag(flagsplugin.Prefix("battery-percentage", prefix), "", flagsplugin.WithHidden(true)))
	...
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("skip-payload-crypto-override", prefix), "", flagsplugin.WithHidden(true)))
