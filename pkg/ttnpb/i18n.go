...
func init() {
	...
	defineEnum(RIGHT_USER_CLIENTS, "view and edit OAuth clients the user is a collaborator of")
	...
	defineEnum(RIGHT_ORGANIZATION_CLIENTS, "list and edit the OAuth clients the organization is a collaborator of")
