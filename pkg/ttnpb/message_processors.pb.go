...
func (c *uplinkMessageProcessorClient) Process(ctx context.Context, in *ProcessUplinkMessageRequest, opts ...grpc.CallOption) (*UplinkMessage, error) {
	...
	err := grpc.Invoke(ctx, "/ttn.lorawan.v3.UplinkMessageProcessor/Process", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *downlinkMessageProcessorClient) Process(ctx context.Context, in *ProcessDownlinkMessageRequest, opts ...grpc.CallOption) (*DownlinkMessage, error) {
	...
	err := grpc.Invoke(ctx, "/ttn.lorawan.v3.DownlinkMessageProcessor/Process", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("go.thethings.network/lorawan-stack/api/message_processors.proto", fileDescriptorMessageProcessors)
}
func init() {
	golang_proto.RegisterFile("go.thethings.network/lorawan-stack/api/message_processors.proto", fileDescriptorMessageProcessors)
}
...
var fileDescriptorMessageProcessors = []byte{
	...
	0x70, 0x9e, 0x22, 0x5c, 0xa4, 0x08, 0x97, 0x29, 0xc2, 0x55, 0x8a, 0xe4, 0x3a, 0x45, 0x72, 0x93,
	0x22, 0x1c, 0x5a, 0x24, 0x47, 0x16, 0xc9, 0xb1, 0x45, 0x38, 0xb1, 0x48, 0x4e, 0x2d, 0xc2, 0x99,
	0x45, 0x18, 0x5b, 0x84, 0x73, 0x8b, 0x70, 0x61, 0x91, 0x5c, 0x5a, 0x84, 0x2b, 0x8b, 0xe4, 0xda,
	0x22, 0xdc, 0x58, 0x24, 0x87, 0x0e, 0xc9, 0x91, 0x43, 0xf8, 0xe2, 0x90, 0x7c, 0x75, 0x08, 0xdf,
	0x1c, 0x92, 0x63, 0x87, 0xe4, 0xc4, 0x21, 0x9c, 0x3a, 0x84, 0x33, 0x87, 0xf0, 0xe9, 0xc5, 0x1c,
	0x07, 0x16, 0xf7, 0xa2, 0xc0, 0x18, 0x19, 0xb7, 0xdb, 0x0f, 0xb3, 0x7b, 0xd9, 0xfc, 0x1d, 0x00,
	0x00, 0xff, 0xff, 0x85, 0x6c, 0x72, 0x70, 0xc8, 0x04, 0x00, 0x00,
}
