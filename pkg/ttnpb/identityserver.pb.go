...
type ListInvitationsRequest_FilterUsed int32

const (
	// Do not filter.
	FILTER_NOFILTER ListInvitationsRequest_FilterUsed = 0
	// List only unused invitations.
	FILTER_UNUSED ListInvitationsRequest_FilterUsed = 1
	// List only used invitations.
	FILTER_USED ListInvitationsRequest_FilterUsed = 2
)

var ListInvitationsRequest_FilterUsed_name = map[int32]string{
	0: "FILTER_NOFILTER",
	1: "FILTER_UNUSED",
	2: "FILTER_USED",
}
var ListInvitationsRequest_FilterUsed_value = map[string]int32{
	"FILTER_NOFILTER": 0,
	"FILTER_UNUSED":   1,
	"FILTER_USED":     2,
}

func (ListInvitationsRequest_FilterUsed) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorIdentityserver, []int{4, 0}
}
...
type ListInvitationsRequest struct {
	// filter_used is an optional field to filter the response by used or unused invitations.
	FilterUsed ListInvitationsRequest_FilterUsed `protobuf:"varint,1,opt,name=filter_used,json=filterUsed,proto3,enum=ttn.v3.ListInvitationsRequest_FilterUsed" json:"filter_used,omitempty"`
}
...
func (m *ListInvitationsRequest) GetFilterUsed() ListInvitationsRequest_FilterUsed {
	if m != nil {
		return m.FilterUsed
	}
	return FILTER_NOFILTER
}
...
type ListInvitationsResponse_Invitation struct {
	// id is the unique autogenerated invitation's ID.
	ID string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// email is the email the invitation was sent at.
	Email string `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`
	// sent_at denotes when the invitation was sent.
	SentAt time.Time `protobuf:"bytes,3,opt,name=sent_at,json=sentAt,stdtime" json:"sent_at"`
	// expires_in denotes how much seconds the invitation will be valid after being
	// issued. This value is set on the moment the invitation is issued based on the
	// `InvitationTokenTTL` setting.
	ExpiresIn uint32 `protobuf:"varint,4,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"`
	// used_at denotes when the invitation was used.
	UsedAt *time.Time `protobuf:"bytes,5,opt,name=used_at,json=usedAt,stdtime" json:"used_at,omitempty"`
	// user_id denotes the ID of the user's account that was created from this invitation.
	UserIdentifier `protobuf:"bytes,6,opt,name=user_id,json=userId,embedded=user_id" json:"user_id"`
}
...
func (m *ListInvitationsResponse_Invitation) GetID() string {
	if m != nil {
		return m.ID
	}
	return ""
...
func (m *ListInvitationsResponse_Invitation) GetSentAt() time.Time {
	if m != nil {
		return m.SentAt
	}
	return time.Time{}
...
func (m *ListInvitationsResponse_Invitation) GetExpiresIn() uint32 {
	if m != nil {
		return m.ExpiresIn
	}
	return 0
...
func (m *ListInvitationsResponse_Invitation) GetUsedAt() *time.Time {
	if m != nil {
		return m.UsedAt
	}
	return nil
...
type RevokeInvitationRequest struct {
	// id is the invitation's ID to be revoked.
	ID string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
}
...
func (m *RevokeInvitationRequest) GetID() string {
	if m != nil {
		return m.ID
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ListInvitationsRequest)(nil), "ttn.v3.ListInvitationsRequest")
	golang_proto.RegisterType((*ListInvitationsRequest)(nil), "ttn.v3.ListInvitationsRequest")
	...
	proto.RegisterType((*RevokeInvitationRequest)(nil), "ttn.v3.RevokeInvitationRequest")
	golang_proto.RegisterType((*RevokeInvitationRequest)(nil), "ttn.v3.RevokeInvitationRequest")
	...
	proto.RegisterEnum("ttn.v3.ListInvitationsRequest_FilterUsed", ListInvitationsRequest_FilterUsed_name, ListInvitationsRequest_FilterUsed_value)
	golang_proto.RegisterEnum("ttn.v3.ListInvitationsRequest_FilterUsed", ListInvitationsRequest_FilterUsed_name, ListInvitationsRequest_FilterUsed_value)
}
func (x ListInvitationsRequest_FilterUsed) String() string {
	s, ok := ListInvitationsRequest_FilterUsed_name[int32(x)]
	if ok {
		return s
	}
...
func (this *ListInvitationsRequest) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	if !ok {
		...
		if ok {
			...
			return fmt.Errorf("that is not of type *ListInvitationsRequest")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *ListInvitationsRequest but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *ListInvitationsRequest but is not nil && this == nil")
	}
	if this.FilterUsed != that1.FilterUsed {
		return fmt.Errorf("FilterUsed this(%v) Not Equal that(%v)", this.FilterUsed, that1.FilterUsed)
	}
	return nil
}
...
func (this *ListInvitationsResponse_Invitation) VerboseEqual(that interface{}) error {
	...
	if !this.SentAt.Equal(that1.SentAt) {
		return fmt.Errorf("SentAt this(%v) Not Equal that(%v)", this.SentAt, that1.SentAt)
	}
	...
	if that1.UsedAt == nil {
		if this.UsedAt != nil {
			return fmt.Errorf("this.UsedAt != nil && that1.UsedAt == nil")
		}
	} else if !this.UsedAt.Equal(*that1.UsedAt) {
		return fmt.Errorf("UsedAt this(%v) Not Equal that(%v)", this.UsedAt, that1.UsedAt)
	}
...
func (this *RevokeInvitationRequest) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	that1, ok := that.(*RevokeInvitationRequest)
	if !ok {
		that2, ok := that.(RevokeInvitationRequest)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *RevokeInvitationRequest")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *RevokeInvitationRequest but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *RevokeInvitationRequest but is not nil && this == nil")
	}
	if this.ID != that1.ID {
		return fmt.Errorf("ID this(%v) Not Equal that(%v)", this.ID, that1.ID)
	}
...
func (this *RevokeInvitationRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
...
type IsAdminClient interface {
	...
	// If the email is modified an email asking for validating it will be sent.
	UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	// ResetUserPassword sets an autogenerated password to an user and sends it
	// to the user's email.
	ResetUserPassword(ctx context.Context, in *UserIdentifier, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	...
	RevokeInvitation(ctx context.Context, in *RevokeInvitationRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	...
	// DeleteClient deletes a client and therefore all the user authorizations
	// are revoked.
...
func (c *isAdminClient) ResetUserPassword(ctx context.Context, in *UserIdentifier, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
...
func (c *isAdminClient) ListInvitations(ctx context.Context, in *ListInvitationsRequest, opts ...grpc.CallOption) (*ListInvitationsResponse, error) {
...
func (c *isAdminClient) RevokeInvitation(ctx context.Context, in *RevokeInvitationRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/ttn.v3.IsAdmin/RevokeInvitation", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IsAdminServer interface {
	...
	// ResetUserPassword sets an autogenerated password to an user and sends it
	// to the user's email.
	ResetUserPassword(context.Context, *UserIdentifier) (*google_protobuf2.Empty, error)
	// DeleteUser deletes an user.
	...
	// RevokeInvitation revokes an invitation that has not been used yet.
	RevokeInvitation(context.Context, *RevokeInvitationRequest) (*google_protobuf2.Empty, error)
	// GetClient returns a client.
...
func _IsAdmin_ListInvitations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsAdminServer).ListInvitations(ctx, req.(*ListInvitationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IsAdmin_RevokeInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeInvitationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IsAdminServer).RevokeInvitation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ttn.v3.IsAdmin/RevokeInvitation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsAdminServer).RevokeInvitation(ctx, req.(*RevokeInvitationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IsAdmin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IsAdmin_RevokeInvitation_Handler,
		},
		{
...
func (m *ListInvitationsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FilterUsed != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintIdentityserver(dAtA, i, uint64(m.FilterUsed))
	}
	return i, nil
}
...
func (m *ListInvitationsResponse_Invitation) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ID) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintIdentityserver(dAtA, i, uint64(len(m.ID)))
		i += copy(dAtA[i:], m.ID)
	}
	if len(m.Email) > 0 {
		dAtA[i] = 0x12
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.SentAt)))
	n9, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.SentAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n9
	if m.ExpiresIn != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintIdentityserver(dAtA, i, uint64(m.ExpiresIn))
	}
	if m.UsedAt != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintIdentityserver(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.UsedAt)))
		n10, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UsedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *RevokeInvitationRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RevokeInvitationRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ListUsersRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ListUsersRequest_FilterState != nil {
		...
		n12, err := m.ListUsersRequest_FilterState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *ListClientsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ListClientsRequest_FilterState != nil {
		...
		n13, err := m.ListClientsRequest_FilterState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *UpdateApplicationRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.UpdateMask.Size()))
	n23, err := m.UpdateMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n23
...
func (m *UpdateApplicationAPIKeyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.ApplicationIdentifier.Size()))
	n27, err := m.ApplicationIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n27
...
func (m *RemoveApplicationAPIKeyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.ApplicationIdentifier.Size()))
	n30, err := m.ApplicationIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
...
func (m *UpdateClientRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.Client.Size()))
	n46, err := m.Client.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n46
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.UpdateMask.Size()))
	n47, err := m.UpdateMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n47
...
func NewPopulatedListInvitationsRequest(r randyIdentityserver, easy bool) *ListInvitationsRequest {
	this := &ListInvitationsRequest{}
	this.FilterUsed = ListInvitationsRequest_FilterUsed([]int32{0, 1, 2}[r.Intn(3)])
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedListInvitationsResponse_Invitation(r randyIdentityserver, easy bool) *ListInvitationsResponse_Invitation {
	...
	this.ID = randStringIdentityserver(r)
	this.Email = randStringIdentityserver(r)
	v11 := github_com_gogo_protobuf_types.NewPopulatedStdTime(r, easy)
	this.SentAt = *v11
	this.ExpiresIn = r.Uint32()
	if r.Intn(10) != 0 {
		this.UsedAt = github_com_gogo_protobuf_types.NewPopulatedStdTime(r, easy)
	}
	v12 := NewPopulatedUserIdentifier(r, easy)
	this.UserIdentifier = *v12
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedRevokeInvitationRequest(r randyIdentityserver, easy bool) *RevokeInvitationRequest {
	this := &RevokeInvitationRequest{}
	this.ID = randStringIdentityserver(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *ListInvitationsRequest) Size() (n int) {
	...
	_ = l
	if m.FilterUsed != 0 {
		n += 1 + sovIdentityserver(uint64(m.FilterUsed))
	}
	return n
}
...
func (m *ListInvitationsResponse_Invitation) Size() (n int) {
	...
	n += 1 + l + sovIdentityserver(uint64(l))
	if m.ExpiresIn != 0 {
		n += 1 + sovIdentityserver(uint64(m.ExpiresIn))
	}
	if m.UsedAt != nil {
		l = github_com_gogo_protobuf_types.SizeOfStdTime(*m.UsedAt)
		n += 1 + l + sovIdentityserver(uint64(l))
	}
...
func (m *RevokeInvitationRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.ID)
	if l > 0 {
...
func (m *ListInvitationsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FilterUsed", wireType)
			}
			m.FilterUsed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FilterUsed |= (ListInvitationsRequest_FilterUsed(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExpiresIn |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			if m.UsedAt == nil {
				m.UsedAt = new(time.Time)
			}
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(m.UsedAt, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *RevokeInvitationRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevokeInvitationRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevokeInvitationRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
