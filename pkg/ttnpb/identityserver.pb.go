...
type SetGatewayAttributeRequest struct {
	GatewayIdentifier `protobuf:"bytes,1,opt,name=gateway_id,json=gatewayId,embedded=gateway_id" json:"gateway_id"`
...
func (m *SetGatewayAttributeRequest) Reset()      { *m = SetGatewayAttributeRequest{} }
func (*SetGatewayAttributeRequest) ProtoMessage() {}
func (*SetGatewayAttributeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorIdentityserver, []int{18}
}

func (m *SetGatewayAttributeRequest) GetAttribute() string {
	if m != nil {
		return m.Attribute
	}
	return ""
...
func (m *SetGatewayAttributeRequest) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SetGatewayAttributeRequest)(nil), "ttn.v3.SetGatewayAttributeRequest")
...
type IsGatewayClient interface {
	...
	// SetGatewayAttribute sets an attribute with a key in the gateway.
	SetGatewayAttribute(ctx context.Context, in *SetGatewayAttributeRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
...
func (c *isGatewayClient) SetGatewayAttribute(ctx context.Context, in *SetGatewayAttributeRequest, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
	err := grpc.Invoke(ctx, "/ttn.v3.IsGateway/SetGatewayAttribute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IsGatewayServer interface {
	...
	// SetGatewayAttribute sets an attribute with a key in the gateway.
	SetGatewayAttribute(context.Context, *SetGatewayAttributeRequest) (*google_protobuf2.Empty, error)
	// RemoveGatewayAttribute removes an attribute matching the given key.
...
func _IsGateway_SetGatewayAttribute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetGatewayAttributeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IsGatewayServer).SetGatewayAttribute(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ttn.v3.IsGateway/SetGatewayAttribute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsGatewayServer).SetGatewayAttribute(ctx, req.(*SetGatewayAttributeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IsGateway_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetGatewayAttribute",
			Handler:    _IsGateway_SetGatewayAttribute_Handler,
		},
		{
...
func (m *SetGatewayAttributeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SetGatewayAttributeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SetGatewayAttributeRequest) Size() (n int) {
	var l int
	_ = l
	l = m.GatewayIdentifier.Size()
	n += 1 + l + sovIdentityserver(uint64(l))
...
func (this *SetGatewayAttributeRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SetGatewayAttributeRequest{`,
		`GatewayIdentifier:` + strings.Replace(strings.Replace(this.GatewayIdentifier.String(), "GatewayIdentifier", "GatewayIdentifier", 1), `&`, ``, 1) + `,`,
...
func (m *SetGatewayAttributeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetGatewayAttributeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetGatewayAttributeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
