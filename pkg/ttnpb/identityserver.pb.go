...
func (m *CreateClientRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Scope) > 0 {
		dAtA26 := make([]byte, len(m.Scope)*10)
		var j25 int
...
func (m *UpdateClientRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Scope) > 0 {
		dAtA31 := make([]byte, len(m.Scope)*10)
		var j30 int
		for _, num := range m.Scope {
			for num >= 1<<7 {
...
func NewPopulatedCreateClientRequest(r randyIdentityserver, easy bool) *CreateClientRequest {
	...
	v36 := r.Intn(10)
	this.Grants = make([]ClientGrant, v36)
	for i := 0; i < v36; i++ {
		this.Grants[i] = ClientGrant([]int32{0, 1, 2}[r.Intn(3)])
	}
	v37 := r.Intn(10)
	this.Scope = make([]ClientScope, v37)
	for i := 0; i < v37; i++ {
...
func NewPopulatedUpdateClientRequest(r randyIdentityserver, easy bool) *UpdateClientRequest {
	...
	this.CallbackURI = string(randStringIdentityserver(r))
	v41 := r.Intn(10)
	this.Grants = make([]ClientGrant, v41)
	for i := 0; i < v41; i++ {
		this.Grants[i] = ClientGrant([]int32{0, 1, 2}[r.Intn(3)])
	}
	v42 := r.Intn(10)
	this.Scope = make([]ClientScope, v42)
	for i := 0; i < v42; i++ {
		this.Scope[i] = ClientScope([]int32{0, 1}[r.Intn(2)])
	}
	if !easy && r.Intn(10) != 0 {
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
