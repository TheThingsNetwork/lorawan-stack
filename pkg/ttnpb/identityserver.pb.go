...
func (*AuthInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_identityserver_e68f152b10e6a639, []int{0}
}
...
func (*AuthInfoResponse_APIKeyAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_identityserver_e68f152b10e6a639, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/identityserver.proto", fileDescriptor_identityserver_e68f152b10e6a639)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/identityserver.proto", fileDescriptor_identityserver_e68f152b10e6a639)
}

var fileDescriptor_identityserver_e68f152b10e6a639 = []byte{
