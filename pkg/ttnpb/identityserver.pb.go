...
type IdentityServerSettings_UserRegistrationFlow struct {
	...
	InvitationOnly bool `protobuf:"varint,2,opt,name=invitation_only,json=invitationOnly,proto3" json:"invitation_only,omitempty"`
...
type IsAdminClient interface {
	...
	GetSettings(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*IdentityServerSettings, error)
	// UpdateSettings updates the editable settings.
	UpdateSettings(ctx context.Context, in *UpdateSettingsRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	DeleteUser(ctx context.Context, in *UserIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	SendInvitation(ctx context.Context, in *SendInvitationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// ListInvitations lists all the sent invitations.
	ListInvitations(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListInvitationsResponse, error)
	// DeleteInvitation revokes an unused invitation or deletes an expired one.
	DeleteInvitation(ctx context.Context, in *DeleteInvitationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateClient(ctx context.Context, in *UpdateClientRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// DeleteClient deletes the client that matches the identifier and revokes all
	// user authorizations.
	DeleteClient(ctx context.Context, in *ClientIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
}
...
func (c *isAdminClient) GetSettings(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*IdentityServerSettings, error) {
...
func (c *isAdminClient) UpdateSettings(ctx context.Context, in *UpdateSettingsRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
...
func (c *isAdminClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) DeleteUser(ctx context.Context, in *UserIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) SendInvitation(ctx context.Context, in *SendInvitationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) ListInvitations(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListInvitationsResponse, error) {
...
func (c *isAdminClient) DeleteInvitation(ctx context.Context, in *DeleteInvitationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) UpdateClient(ctx context.Context, in *UpdateClientRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isAdminClient) DeleteClient(ctx context.Context, in *ClientIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsAdminServer interface {
	// GetSettings returns the values of the editable settings.
	GetSettings(context.Context, *google_protobuf1.Empty) (*IdentityServerSettings, error)
	// UpdateSettings updates the editable settings.
	UpdateSettings(context.Context, *UpdateSettingsRequest) (*google_protobuf1.Empty, error)
	// CreateUser creates an account on behalf of an user.
	// A password is generated and sent to the user's email.
	...
	// If email address is updated it sends an email to validate it if and only if
	// the `SkipValidation` setting is disabled.
	UpdateUser(context.Context, *UpdateUserRequest) (*google_protobuf1.Empty, error)
	// ResetUserPassword sets an autogenerated password to the user that matches
	// the identifier. The new password is returned on the response but also send
	// by email to the user.
	ResetUserPassword(context.Context, *UserIdentifier) (*ResetUserPasswordResponse, error)
	// DeleteUser deletes an user.
	DeleteUser(context.Context, *UserIdentifier) (*google_protobuf1.Empty, error)
	// SendInvitation sends by email a token that can be used to create a new account.
	// All invitations are expirable and the TTL is defined on a setitngs variable.
	SendInvitation(context.Context, *SendInvitationRequest) (*google_protobuf1.Empty, error)
	// ListInvitations lists all the sent invitations.
	ListInvitations(context.Context, *google_protobuf1.Empty) (*ListInvitationsResponse, error)
	// DeleteInvitation revokes an unused invitation or deletes an expired one.
	DeleteInvitation(context.Context, *DeleteInvitationRequest) (*google_protobuf1.Empty, error)
	// GetClient returns the client that matches the identifier.
	GetClient(context.Context, *ClientIdentifier) (*Client, error)
	// ListClients returns a list of third-party clients with optional filtering.
	ListClients(context.Context, *ListClientsRequest) (*ListClientsResponse, error)
	// UpdateClient updates a third-party client.
	UpdateClient(context.Context, *UpdateClientRequest) (*google_protobuf1.Empty, error)
	// DeleteClient deletes the client that matches the identifier and revokes all
	// user authorizations.
	DeleteClient(context.Context, *ClientIdentifier) (*google_protobuf1.Empty, error)
}
...
func _IsAdmin_GetSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsAdminServer).GetSettings(ctx, req.(*google_protobuf1.Empty))
	}
...
func _IsAdmin_ListInvitations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsAdminServer).ListInvitations(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type IsUserClient interface {
	...
	GetUser(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*User, error)
	...
	UpdateUserPassword(ctx context.Context, in *UpdateUserPasswordRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// DeleteUser permantly deletes the user account of the authenticated user.
	DeleteUser(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	ListUserAPIKeys(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListUserAPIKeysResponse, error)
	// UpdateUserAPIKey updates the rights of an API key of the authenticated user.
	UpdateUserAPIKey(ctx context.Context, in *UpdateUserAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// RemoveUserAPIKey removes an API key from the authenticated user.
	RemoveUserAPIKey(ctx context.Context, in *RemoveUserAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	ValidateUserEmail(ctx context.Context, in *ValidateUserEmailRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	RequestUserEmailValidation(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	ListAuthorizedClients(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListAuthorizedClientsResponse, error)
	// RevokeClient revokes the access of an authorized client to the authenticated
	// user's account.
	RevokeAuthorizedClient(ctx context.Context, in *ClientIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
}
...
func (c *isUserClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) GetUser(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *isUserClient) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) UpdateUserPassword(ctx context.Context, in *UpdateUserPasswordRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) DeleteUser(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) ListUserAPIKeys(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListUserAPIKeysResponse, error) {
...
func (c *isUserClient) UpdateUserAPIKey(ctx context.Context, in *UpdateUserAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) RemoveUserAPIKey(ctx context.Context, in *RemoveUserAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) ValidateUserEmail(ctx context.Context, in *ValidateUserEmailRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) RequestUserEmailValidation(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isUserClient) ListAuthorizedClients(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListAuthorizedClientsResponse, error) {
...
func (c *isUserClient) RevokeAuthorizedClient(ctx context.Context, in *ClientIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsUserServer interface {
	...
	CreateUser(context.Context, *CreateUserRequest) (*google_protobuf1.Empty, error)
	// GetUser returns the current user.
	GetUser(context.Context, *google_protobuf1.Empty) (*User, error)
	// UpdateUser edits the profile of the authenticated user.
	// If email address is updated it sends an email to validate it if and only if
	// the `SkipValidation` setting is disabled.
	UpdateUser(context.Context, *UpdateUserRequest) (*google_protobuf1.Empty, error)
	// UpdateUserPassword sets a new password for the authenticated user account.
	UpdateUserPassword(context.Context, *UpdateUserPasswordRequest) (*google_protobuf1.Empty, error)
	// DeleteUser permantly deletes the user account of the authenticated user.
	DeleteUser(context.Context, *google_protobuf1.Empty) (*google_protobuf1.Empty, error)
	// GenerateUserAPIKey generates a new API key for the authenticated user and returns it.
	GenerateUserAPIKey(context.Context, *GenerateUserAPIKeyRequest) (*APIKey, error)
	// ListUserAPIKeys returns all the user API keys that the authenticated user has.
	ListUserAPIKeys(context.Context, *google_protobuf1.Empty) (*ListUserAPIKeysResponse, error)
	// UpdateUserAPIKey updates the rights of an API key of the authenticated user.
	UpdateUserAPIKey(context.Context, *UpdateUserAPIKeyRequest) (*google_protobuf1.Empty, error)
	// RemoveUserAPIKey removes an API key from the authenticated user.
	RemoveUserAPIKey(context.Context, *RemoveUserAPIKeyRequest) (*google_protobuf1.Empty, error)
	// ValidateUserEmail validates the user's email address of the authenticated
	// user by using the token sent to the user's email address.
	ValidateUserEmail(context.Context, *ValidateUserEmailRequest) (*google_protobuf1.Empty, error)
	// RequestUserEmailValidation re-issues a new email validation token and sends
	// it to the user's email address so he can validate it. Any previous validation
	// token that has not been used will be revoked.
	RequestUserEmailValidation(context.Context, *google_protobuf1.Empty) (*google_protobuf1.Empty, error)
	// ListAuthorizedClients returns the list of clients that the authenticated user
	// has currently authorized to access its account.
	ListAuthorizedClients(context.Context, *google_protobuf1.Empty) (*ListAuthorizedClientsResponse, error)
	// RevokeClient revokes the access of an authorized client to the authenticated
	// user's account.
	RevokeAuthorizedClient(context.Context, *ClientIdentifier) (*google_protobuf1.Empty, error)
}
...
func _IsUser_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsUserServer).GetUser(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IsUser_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsUserServer).DeleteUser(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IsUser_ListUserAPIKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsUserServer).ListUserAPIKeys(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IsUser_RequestUserEmailValidation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsUserServer).RequestUserEmailValidation(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IsUser_ListAuthorizedClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsUserServer).ListAuthorizedClients(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type IsApplicationClient interface {
	...
	// with enough rights.
	CreateApplication(ctx context.Context, in *CreateApplicationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateApplication(ctx context.Context, in *UpdateApplicationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// DeleteApplication permantly deletes an application.
	DeleteApplication(ctx context.Context, in *ApplicationIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateApplicationAPIKey(ctx context.Context, in *UpdateApplicationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// RemoveApplicationAPIKey removes a given API key from an application.
	RemoveApplicationAPIKey(ctx context.Context, in *RemoveApplicationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	SetApplicationCollaborator(ctx context.Context, in *ApplicationCollaborator, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
...
func (c *isApplicationClient) CreateApplication(ctx context.Context, in *CreateApplicationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isApplicationClient) UpdateApplication(ctx context.Context, in *UpdateApplicationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isApplicationClient) DeleteApplication(ctx context.Context, in *ApplicationIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isApplicationClient) UpdateApplicationAPIKey(ctx context.Context, in *UpdateApplicationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isApplicationClient) RemoveApplicationAPIKey(ctx context.Context, in *RemoveApplicationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isApplicationClient) SetApplicationCollaborator(ctx context.Context, in *ApplicationCollaborator, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsApplicationServer interface {
	...
	// rights if and only if the authenticated user is member of the organization
	// with enough rights.
	CreateApplication(context.Context, *CreateApplicationRequest) (*google_protobuf1.Empty, error)
	// GetApplication returns the application that matches the identifier.
	...
	// UpdateApplication edits an application.
	UpdateApplication(context.Context, *UpdateApplicationRequest) (*google_protobuf1.Empty, error)
	// DeleteApplication permantly deletes an application.
	DeleteApplication(context.Context, *ApplicationIdentifier) (*google_protobuf1.Empty, error)
	// GenerateApplicationAPIKey generates a new API key for a given application
	// and returns it.
	...
	// UpdateApplicationAPIKey updates the rights of a given application API key.
	UpdateApplicationAPIKey(context.Context, *UpdateApplicationAPIKeyRequest) (*google_protobuf1.Empty, error)
	// RemoveApplicationAPIKey removes a given API key from an application.
	RemoveApplicationAPIKey(context.Context, *RemoveApplicationAPIKeyRequest) (*google_protobuf1.Empty, error)
	// SetApplicationCollaborator sets a collaborationship between an user and an
	// application upon a given set of rights.
	//
	// The call will return error if after perform the operation the sum of rights
	// that all collaborators with `RIGHT_APPLICATION_SETTINGS_COLLABORATORS` right
	// is not equal to entire set of available `RIGHT_APPLICATION_XXXXXX` rights.
	SetApplicationCollaborator(context.Context, *ApplicationCollaborator) (*google_protobuf1.Empty, error)
	// ListApplicationCollaborators returns all the collaborators for a given application.
...
type IsGatewayClient interface {
	...
	CreateGateway(ctx context.Context, in *CreateGatewayRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateGateway(ctx context.Context, in *UpdateGatewayRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// DeleteGateway permantly deletes a gateway.
	DeleteGateway(ctx context.Context, in *GatewayIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateGatewayAPIKey(ctx context.Context, in *UpdateGatewayAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// RemoveGatewayAPIKey removes a given API key from a gateway.
	RemoveGatewayAPIKey(ctx context.Context, in *RemoveGatewayAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	SetGatewayCollaborator(ctx context.Context, in *GatewayCollaborator, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
...
func (c *isGatewayClient) CreateGateway(ctx context.Context, in *CreateGatewayRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isGatewayClient) UpdateGateway(ctx context.Context, in *UpdateGatewayRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isGatewayClient) DeleteGateway(ctx context.Context, in *GatewayIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isGatewayClient) UpdateGatewayAPIKey(ctx context.Context, in *UpdateGatewayAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isGatewayClient) RemoveGatewayAPIKey(ctx context.Context, in *RemoveGatewayAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isGatewayClient) SetGatewayCollaborator(ctx context.Context, in *GatewayCollaborator, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsGatewayServer interface {
	...
	// will be added as collaborator with all the possible rights if and only if
	// the authenticated user is member of the organization with enough rights.
	CreateGateway(context.Context, *CreateGatewayRequest) (*google_protobuf1.Empty, error)
	// GetGateway returns the gateway that matches the identifier.
	...
	// UpdateGateway edits a gateway and retrieves the updated version.
	UpdateGateway(context.Context, *UpdateGatewayRequest) (*google_protobuf1.Empty, error)
	// DeleteGateway permantly deletes a gateway.
	DeleteGateway(context.Context, *GatewayIdentifier) (*google_protobuf1.Empty, error)
	// GenerateGatewayAPIKey generates a new API key for a given gateway and
	// returns it.
	...
	// UpdateGatewayAPIKey updates the rights of a gateway API key.
	UpdateGatewayAPIKey(context.Context, *UpdateGatewayAPIKeyRequest) (*google_protobuf1.Empty, error)
	// RemoveGatewayAPIKey removes a given API key from a gateway.
	RemoveGatewayAPIKey(context.Context, *RemoveGatewayAPIKeyRequest) (*google_protobuf1.Empty, error)
	// SetGatewayCollaborator sets a collaborationship between an user and an
	// gateway upon a given set of rights.
	//
	// The call will return error if after perform the operation the sum of rights
	// that all collaborators with `RIGHT_GATEWAY_SETTINGS_COLLABORATORS` right
	// is not equal to entire set of available `RIGHT_GATEWAY_XXXXXX` rights.
	SetGatewayCollaborator(context.Context, *GatewayCollaborator) (*google_protobuf1.Empty, error)
	// ListGatewayCollaborators returns all the collaborators for a given gateway.
...
type IsClientClient interface {
	...
	CreateClient(ctx context.Context, in *CreateClientRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// GetClient returns the client that matches the identifier.
	...
	ListClients(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListClientsResponse, error)
...
func (c *isClientClient) CreateClient(ctx context.Context, in *CreateClientRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isClientClient) ListClients(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListClientsResponse, error) {
	out := new(ListClientsResponse)
...
func (c *isClientClient) UpdateClient(ctx context.Context, in *UpdateClientRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isClientClient) DeleteClient(ctx context.Context, in *ClientIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsClientServer interface {
	// CreateClient sends a request to create a third-party client. The request
	// has to be approved by the admins.
	CreateClient(context.Context, *CreateClientRequest) (*google_protobuf1.Empty, error)
	// GetClient returns the client that matches the identifier.
	// It allows to be called without authorization credentials, in this case it
	// will only return the publicly information available about the client.
	GetClient(context.Context, *ClientIdentifier) (*Client, error)
	// ListClients returns all the clients the authenticated user has created.
	ListClients(context.Context, *google_protobuf1.Empty) (*ListClientsResponse, error)
	// UpdateClient sends a request to update a client.
	UpdateClient(context.Context, *UpdateClientRequest) (*google_protobuf1.Empty, error)
	// DeleteClient deletes the client that matches the identifier and revokes all
	// user authorizations.
...
func _IsClient_ListClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsClientServer).ListClients(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type IsOrganizationClient interface {
	...
	ListOrganizations(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListOrganizationsResponse, error)
	// UpdateOrganization updates an organization.
	UpdateOrganization(ctx context.Context, in *UpdateOrganizationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// DeleteOrganization deletes an organization.
	DeleteOrganization(ctx context.Context, in *OrganizationIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	UpdateOrganizationAPIKey(ctx context.Context, in *UpdateOrganizationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	// RemoveOrganizationAPIKey removes an organization's API key.
	RemoveOrganizationAPIKey(ctx context.Context, in *RemoveOrganizationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
	...
	SetOrganizationMember(ctx context.Context, in *OrganizationMember, opts ...grpc.CallOption) (*google_protobuf1.Empty, error)
...
func (c *isOrganizationClient) CreateOrganization(ctx context.Context, in *CreateOrganizationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isOrganizationClient) ListOrganizations(ctx context.Context, in *google_protobuf1.Empty, opts ...grpc.CallOption) (*ListOrganizationsResponse, error) {
...
func (c *isOrganizationClient) UpdateOrganization(ctx context.Context, in *UpdateOrganizationRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isOrganizationClient) DeleteOrganization(ctx context.Context, in *OrganizationIdentifier, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isOrganizationClient) UpdateOrganizationAPIKey(ctx context.Context, in *UpdateOrganizationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isOrganizationClient) RemoveOrganizationAPIKey(ctx context.Context, in *RemoveOrganizationAPIKeyRequest, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
func (c *isOrganizationClient) SetOrganizationMember(ctx context.Context, in *OrganizationMember, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
...
type IsOrganizationServer interface {
	...
	// ListOrganizations returns the list of organizations the caller is member of.
	ListOrganizations(context.Context, *google_protobuf1.Empty) (*ListOrganizationsResponse, error)
	// UpdateOrganization updates an organization.
	UpdateOrganization(context.Context, *UpdateOrganizationRequest) (*google_protobuf1.Empty, error)
	// DeleteOrganization deletes an organization.
	DeleteOrganization(context.Context, *OrganizationIdentifier) (*google_protobuf1.Empty, error)
	// GenerateOrganizationAPIKey generates an API key and returns it.
	...
	// UpdateOrganizationAPIKey updates an organization's API key.
	UpdateOrganizationAPIKey(context.Context, *UpdateOrganizationAPIKeyRequest) (*google_protobuf1.Empty, error)
	// RemoveOrganizationAPIKey removes an organization's API key.
	RemoveOrganizationAPIKey(context.Context, *RemoveOrganizationAPIKeyRequest) (*google_protobuf1.Empty, error)
	// SetOrganizationMember sets a membership between an user and an organization
	// upon a given set of rights.
	//
	// The call will return error if after perform the operation the sum of rights
	// that all members with `RIGHT_ORGANIZATION_SETTINGS_COLLABORATORS` right
	// is not equal to entire set of available `RIGHT_ORGANIZATION_XXXXXX` rights.
	SetOrganizationMember(context.Context, *OrganizationMember) (*google_protobuf1.Empty, error)
	// ListOrganizationMembers returns a list of all the members that belong to an organization.
...
func _IsOrganization_ListOrganizations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IsOrganizationServer).ListOrganizations(ctx, req.(*google_protobuf1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
