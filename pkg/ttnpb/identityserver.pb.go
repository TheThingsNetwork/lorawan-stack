...
type IdentityServerSettings struct {
	...
	IdentityServerSettings_UserRegistrationFlow `protobuf:"bytes,2,opt,name=user_registration,json=userRegistration,embedded=user_registration" json:"user_registration"`
...
func (m *IdentityServerSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	n3, err := m.IdentityServerSettings_UserRegistrationFlow.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	...
	n4, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.ValidationTokenTTL, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *GetSettingsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProjectionMask != nil {
		...
		i++
		i = encodeVarintIdentityserver(dAtA, i, uint64(m.ProjectionMask.Size()))
		n5, err := m.ProjectionMask.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func NewPopulatedIdentityServerSettings(r randyIdentityserver, easy bool) *IdentityServerSettings {
	...
	v2 := r.Intn(10)
	this.BlacklistedIDs = make([]string, v2)
	for i := 0; i < v2; i++ {
		this.BlacklistedIDs[i] = randStringIdentityserver(r)
	}
	v3 := NewPopulatedIdentityServerSettings_UserRegistrationFlow(r, easy)
	this.IdentityServerSettings_UserRegistrationFlow = *v3
	v4 := github_com_gogo_protobuf_types.NewPopulatedStdDuration(r, easy)
	this.ValidationTokenTTL = *v4
	v5 := r.Intn(10)
	this.AllowedEmails = make([]string, v5)
	for i := 0; i < v5; i++ {
...
func NewPopulatedUpdateSettingsRequest(r randyIdentityserver, easy bool) *UpdateSettingsRequest {
	...
	v6 := NewPopulatedIdentityServerSettings(r, easy)
	this.Settings = *v6
	v7 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v7
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedUpdateUserRequest(r randyIdentityserver, easy bool) *UpdateUserRequest {
	...
	this.User = *v9
	v10 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v10
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedListUserAPIKeysResponse(r randyIdentityserver, easy bool) *ListUserAPIKeysResponse {
	...
	if r.Intn(10) != 0 {
		v12 := r.Intn(5)
		this.APIKeys = make([]APIKey, v12)
		for i := 0; i < v12; i++ {
			v13 := NewPopulatedAPIKey(r, easy)
			this.APIKeys[i] = *v13
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedCreateApplicationRequest(r randyIdentityserver, easy bool) *CreateApplicationRequest {
	...
	v17 := NewPopulatedApplication(r, easy)
	this.Application = *v17
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedListApplicationsResponse(r randyIdentityserver, easy bool) *ListApplicationsResponse {
	...
	if r.Intn(10) != 0 {
		v18 := r.Intn(5)
		this.Applications = make([]Application, v18)
		for i := 0; i < v18; i++ {
			v19 := NewPopulatedApplication(r, easy)
			this.Applications[i] = *v19
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedUpdateApplicationRequest(r randyIdentityserver, easy bool) *UpdateApplicationRequest {
	...
	this.Application = *v20
	v21 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v21
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedListApplicationCollaboratorsResponse(r randyIdentityserver, easy bool) *ListApplicationCollaboratorsResponse {
	...
	if r.Intn(10) != 0 {
		v29 := r.Intn(5)
		this.Collaborators = make([]ApplicationCollaborator, v29)
		for i := 0; i < v29; i++ {
			v30 := NewPopulatedApplicationCollaborator(r, easy)
			this.Collaborators[i] = *v30
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedCreateGatewayRequest(r randyIdentityserver, easy bool) *CreateGatewayRequest {
	...
	v32 := NewPopulatedGateway(r, easy)
	this.Gateway = *v32
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedListGatewaysResponse(r randyIdentityserver, easy bool) *ListGatewaysResponse {
	...
	if r.Intn(10) != 0 {
		v33 := r.Intn(5)
		this.Gateways = make([]Gateway, v33)
		for i := 0; i < v33; i++ {
...
func NewPopulatedListGatewayCollaboratorsResponse(r randyIdentityserver, easy bool) *ListGatewayCollaboratorsResponse {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v44; i++ {
			v45 := NewPopulatedGatewayCollaborator(r, easy)
			this.Collaborators[i] = *v45
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedUpdateClientRequest(r randyIdentityserver, easy bool) *UpdateClientRequest {
	...
	this.Client = *v50
	v51 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v51
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldIdentityserver(dAtA []byte, r randyIdentityserver, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateIdentityserver(dAtA, uint64(v53))
	case 1:
		dAtA = encodeVarintPopulateIdentityserver(dAtA, uint64(key))
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
