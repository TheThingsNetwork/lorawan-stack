...
type ListInvitationsResponse_Invitation struct {
	...
	UsedAt *time.Time `protobuf:"bytes,4,opt,name=used_at,json=usedAt,stdtime" json:"used_at,omitempty"`
	// user_id denotes the ID of the user's account that was created from this invitation.
	UserIdentifier `protobuf:"bytes,5,opt,name=user_id,json=userId,embedded=user_id" json:"user_id"`
}
...
func (m *ListInvitationsResponse_Invitation) GetTTL() time.Duration {
	if m != nil {
		return m.TTL
	}
	return 0
...
func (m *RevokeInvitationRequest) GetEmail() string {
	if m != nil {
		return m.Email
	}
	return ""
...
func (m *ListInvitationsResponse_Invitation) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.TTL)))
	n10, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TTL, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n10
	if m.UsedAt != nil {
		...
		n11, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.UsedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	n12, err := m.UserIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n12
...
func (m *ListUsersRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ListUsersRequest_FilterState != nil {
		...
		n13, err := m.ListUsersRequest_FilterState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *ListClientsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ListClientsRequest_FilterState != nil {
		...
		n14, err := m.ListClientsRequest_FilterState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *UpdateGatewayRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.Gateway.Size()))
	n35, err := m.Gateway.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.UpdateMask.Size()))
	n36, err := m.UpdateMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
...
func (m *GenerateGatewayAPIKeyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.GatewayIdentifier.Size()))
	n37, err := m.GatewayIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
	...
	if len(m.Rights) > 0 {
		dAtA39 := make([]byte, len(m.Rights)*10)
		var j38 int
		for _, num := range m.Rights {
			for num >= 1<<7 {
...
func (m *UpdateGatewayAPIKeyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.GatewayIdentifier.Size()))
	n40, err := m.GatewayIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
	...
	if len(m.Rights) > 0 {
		dAtA42 := make([]byte, len(m.Rights)*10)
		var j41 int
		for _, num := range m.Rights {
			for num >= 1<<7 {
...
func (m *RemoveGatewayAPIKeyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.GatewayIdentifier.Size()))
	n43, err := m.GatewayIdentifier.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n43
...
func (m *ListGatewayRightsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Rights) > 0 {
		dAtA45 := make([]byte, len(m.Rights)*10)
		var j44 int
		for _, num := range m.Rights {
			for num >= 1<<7 {
...
func (m *UpdateClientRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.Client.Size()))
	n47, err := m.Client.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n47
	...
	i++
	i = encodeVarintIdentityserver(dAtA, i, uint64(m.UpdateMask.Size()))
	n48, err := m.UpdateMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
...
func NewPopulatedListInvitationsResponse_Invitation(r randyIdentityserver, easy bool) *ListInvitationsResponse_Invitation {
	...
	v13 := NewPopulatedUserIdentifier(r, easy)
	this.UserIdentifier = *v13
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedCreateApplicationRequest(r randyIdentityserver, easy bool) *CreateApplicationRequest {
	...
	v22 := NewPopulatedApplication(r, easy)
	this.Application = *v22
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedListApplicationsResponse(r randyIdentityserver, easy bool) *ListApplicationsResponse {
	...
	if r.Intn(10) != 0 {
		v23 := r.Intn(5)
		this.Applications = make([]*Application, v23)
		for i := 0; i < v23; i++ {
...
func NewPopulatedUpdateApplicationRequest(r randyIdentityserver, easy bool) *UpdateApplicationRequest {
	...
	v24 := NewPopulatedApplication(r, easy)
	this.Application = *v24
	v25 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v25
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGenerateApplicationAPIKeyRequest(r randyIdentityserver, easy bool) *GenerateApplicationAPIKeyRequest {
	...
	v26 := NewPopulatedApplicationIdentifier(r, easy)
	this.ApplicationIdentifier = *v26
	this.Name = randStringIdentityserver(r)
	v27 := r.Intn(10)
...
func NewPopulatedRemoveApplicationAPIKeyRequest(r randyIdentityserver, easy bool) *RemoveApplicationAPIKeyRequest {
	...
	v31 := NewPopulatedApplicationIdentifier(r, easy)
	this.ApplicationIdentifier = *v31
	this.Name = randStringIdentityserver(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedListApplicationCollaboratorsResponse(r randyIdentityserver, easy bool) *ListApplicationCollaboratorsResponse {
	...
	if r.Intn(10) != 0 {
		v32 := r.Intn(5)
		this.Collaborators = make([]*ApplicationCollaborator, v32)
		for i := 0; i < v32; i++ {
...
func NewPopulatedListGatewaysResponse(r randyIdentityserver, easy bool) *ListGatewaysResponse {
	...
	if r.Intn(10) != 0 {
		v35 := r.Intn(5)
		this.Gateways = make([]*Gateway, v35)
		for i := 0; i < v35; i++ {
...
func NewPopulatedRemoveGatewayAPIKeyRequest(r randyIdentityserver, easy bool) *RemoveGatewayAPIKeyRequest {
	...
	v43 := NewPopulatedGatewayIdentifier(r, easy)
	this.GatewayIdentifier = *v43
	this.Name = randStringIdentityserver(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedListGatewayCollaboratorsResponse(r randyIdentityserver, easy bool) *ListGatewayCollaboratorsResponse {
	...
	if r.Intn(10) != 0 {
		v44 := r.Intn(5)
		this.Collaborators = make([]*GatewayCollaborator, v44)
		for i := 0; i < v44; i++ {
...
func NewPopulatedUpdateClientRequest(r randyIdentityserver, easy bool) *UpdateClientRequest {
	...
	this.Client = *v48
	v49 := google_protobuf5.NewPopulatedFieldMask(r, easy)
	this.UpdateMask = *v49
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
var fileDescriptorIdentityserver = []byte{
	...
	,
}
