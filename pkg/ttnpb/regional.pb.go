...
func (m *FrequencyPlan_DwellTime) String() string { return proto.CompactTextString(m) }
func (*FrequencyPlan_DwellTime) ProtoMessage()    {}
func (*FrequencyPlan_DwellTime) Descriptor() ([]byte, []int) {
	return fileDescriptorRegional, []int{0, 0}
}
...
func (*FrequencyPlan_Channel) Descriptor() ([]byte, []int) { return fileDescriptorRegional, []int{0, 1} }
...
func (*FrequencyPlan_Channel_ForceDataRate) Descriptor() ([]byte, []int) {
	return fileDescriptorRegional, []int{0, 1, 0}
}
...
func (*FrequencyPlan_TimeOffAir) Descriptor() ([]byte, []int) {
	return fileDescriptorRegional, []int{0, 3}
}
...
func (m *FrequencyPlan_TimeOffAir) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Duration != nil {
		...
		i++
		i = encodeVarintRegional(dAtA, i, uint64(types.SizeOfStdDuration(*m.Duration)))
		n11, err := types.StdDurationMarshalTo(*m.Duration, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
var fileDescriptorRegional = []byte{
	...
	,
}
