...
type FrequencyPlan struct {
	...
	// Enable dwell time limitations on uplink transmissions.
	UplinkDwellTime bool `protobuf:"varint,7,opt,name=uplink_dwell_time,json=uplinkDwellTime,proto3" json:"uplink_dwell_time,omitempty" yaml:"uplink-dwell-time,omitempty"`
	// Enable dwell time limitations on downlink transmissions.
	DownlinkDwellTime bool `protobuf:"varint,8,opt,name=downlink_dwell_time,json=downlinkDwellTime,proto3" json:"downlink_dwell_time,omitempty" yaml:"downlink-dwell-time,omitempty"`
...
func (m *FrequencyPlan) GetUplinkDwellTime() bool {
	if m != nil {
...
func (m *FrequencyPlan) GetDownlinkDwellTime() bool {
	if m != nil {
...
func (m *FrequencyPlan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PingSlot != nil {
		...
		n5, err := m.PingSlot.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *FrequencyPlan_Channel) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DataRate != nil {
		...
		n7, err := m.DataRate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
var fileDescriptorRegional = []byte{
	...
	,
}
