...
func (*ConcentratorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_f69214f18cafc4dc, []int{0}
}
...
func (*ConcentratorConfig_Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_f69214f18cafc4dc, []int{0, 0}
}
...
func (*ConcentratorConfig_LoRaStandardChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_f69214f18cafc4dc, []int{0, 1}
}
...
func (*ConcentratorConfig_FSKChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_f69214f18cafc4dc, []int{0, 2}
}
...
func (*ConcentratorConfig_LBTConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_f69214f18cafc4dc, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_f69214f18cafc4dc)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_f69214f18cafc4dc)
}

var fileDescriptor_regional_f69214f18cafc4dc = []byte{
	// 727 bytes of a gzipped FileDescriptorProto
	,
}
