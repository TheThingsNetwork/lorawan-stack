...
func (*ConcentratorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_19685b753f0722a7, []int{0}
}
...
func (*ConcentratorConfig_Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_19685b753f0722a7, []int{0, 0}
}
...
func (*ConcentratorConfig_LoRaStandardChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_19685b753f0722a7, []int{0, 1}
}
...
func (*ConcentratorConfig_FSKChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_19685b753f0722a7, []int{0, 2}
}
...
func (*ConcentratorConfig_LBTConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_19685b753f0722a7, []int{0, 3}
}
...
func (m *ConcentratorConfig_LBTConfiguration) MarshalTo(dAtA []byte) (int, error) {
	...
	n7, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.ScanTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n7
...
func randFieldRegional(dAtA []byte, r randyRegional, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateRegional(dAtA, uint64(v7))
	case 1:
		dAtA = encodeVarintPopulateRegional(dAtA, uint64(key))
...
func init() {
	proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_19685b753f0722a7)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_19685b753f0722a7)
}

var fileDescriptor_regional_19685b753f0722a7 = []byte{
	...
	,
}
