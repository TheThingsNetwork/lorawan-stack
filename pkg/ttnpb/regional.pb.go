...
func (*ConcentratorConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_1b1da43b69ff008d, []int{0}
}
...
func (*ConcentratorConfig_Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_1b1da43b69ff008d, []int{0, 0}
}
...
func (*ConcentratorConfig_LoRaStandardChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_1b1da43b69ff008d, []int{0, 1}
}
...
func (*ConcentratorConfig_FSKChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_1b1da43b69ff008d, []int{0, 2}
}
...
func (*ConcentratorConfig_LBTConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_regional_1b1da43b69ff008d, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_1b1da43b69ff008d)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/regional.proto", fileDescriptor_regional_1b1da43b69ff008d)
}

var fileDescriptor_regional_1b1da43b69ff008d = []byte{
	// 759 bytes of a gzipped FileDescriptorProto
	,
}
