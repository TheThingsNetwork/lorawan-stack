...
var (
	...
	pattern_Configuration_GetPhyVersions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"configuration", "phy-version"}, "", runtime.AssumeColonVerbOpt(true)))
)
