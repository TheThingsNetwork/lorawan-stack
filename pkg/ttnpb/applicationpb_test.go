...
func TestApplicationMaskProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
	}
...
func TestApplicationMaskMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, false)
	size := p.Size()
...
func BenchmarkApplicationMaskProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*ApplicationMask, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedApplicationMask(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(pops[i%10000])
...
func BenchmarkApplicationMaskProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedApplicationMask(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestApplicationMaskJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, true)
	marshaler := github_com_gogo_protobuf_jsonpb.Marshaler{}
	jsondata, err := marshaler.MarshalToString(p)
	if err != nil {
		t.Fatalf("seed = %d, err = %v", seed, err)
...
func TestApplicationMaskProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, true)
	dAtA := github_com_gogo_protobuf_proto.MarshalTextString(p)
...
func TestApplicationMaskProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, true)
	dAtA := github_com_gogo_protobuf_proto.CompactTextString(p)
...
func TestApplicationMaskVerboseEqual(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedApplicationMask(popr, false)
	dAtA, err := github_com_gogo_protobuf_proto.Marshal(p)
	if err != nil {
...
func TestApplicationMaskSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedApplicationMask(popr, true)
	size2 := github_com_gogo_protobuf_proto.Size(p)
...
func BenchmarkApplicationMaskSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*ApplicationMask, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedApplicationMask(popr, false)
	}
	b.ResetTimer()
