...
var Right_name = map[int32]string{
	...
	57: "RIGHT_GATEWAY_WRITE_SECRET",
	58: "RIGHT_GATEWAY_READ_SECRET",
...
var Right_value = map[string]int32{
	...
	"RIGHT_GATEWAY_WRITE_SECRET":               57,
	"RIGHT_GATEWAY_READ_SECRET":                58,
...
var fileDescriptor_9bb69af2cf8904c5 = []byte{
	...
	,
}
