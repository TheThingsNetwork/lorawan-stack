...
func (*SessionKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_12e21d9ce518aef5, []int{0}
}
...
func (*NwkSKeysResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_12e21d9ce518aef5, []int{1}
}
...
func (*AppSKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_12e21d9ce518aef5, []int{2}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/joinserver.proto", fileDescriptor_joinserver_12e21d9ce518aef5)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/joinserver.proto", fileDescriptor_joinserver_12e21d9ce518aef5)
}

var fileDescriptor_joinserver_12e21d9ce518aef5 = []byte{
	// 877 bytes of a gzipped FileDescriptorProto
	,
}
