...
func (*SessionKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_4b5a88eb9ee46b4a, []int{0}
}
...
func (*NwkSKeysResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_4b5a88eb9ee46b4a, []int{1}
}
...
func (*AppSKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_joinserver_4b5a88eb9ee46b4a, []int{2}
}
...
var _NsJs_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "go.thethings.network/lorawan-stack/api/joinserver.proto",
}
...
func init() {
	proto.RegisterFile("go.thethings.network/lorawan-stack/api/joinserver.proto", fileDescriptor_joinserver_4b5a88eb9ee46b4a)
}
func init() {
	golang_proto.RegisterFile("go.thethings.network/lorawan-stack/api/joinserver.proto", fileDescriptor_joinserver_4b5a88eb9ee46b4a)
}

var fileDescriptor_joinserver_4b5a88eb9ee46b4a = []byte{
	// 531 bytes of a gzipped FileDescriptorProto
	,
}
