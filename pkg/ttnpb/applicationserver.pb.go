...
func (*ApplicationLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_cf747353cada2639, []int{0}
}
...
func (*GetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_cf747353cada2639, []int{1}
}
...
func (*SetApplicationLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_applicationserver_cf747353cada2639, []int{2}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_cf747353cada2639)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/applicationserver.proto", fileDescriptor_applicationserver_cf747353cada2639)
}

var fileDescriptor_applicationserver_cf747353cada2639 = []byte{
	// 964 bytes of a gzipped FileDescriptorProto
	,
}
