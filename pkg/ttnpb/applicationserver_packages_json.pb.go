...
func (x *GetApplicationPackageDefaultAssociationRequest) MarshalProtoJSON(s *jsonplugin.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	...
	if x.Ids != nil || s.HasField("ids") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("ids")
		// NOTE: ApplicationPackageDefaultAssociationIdentifiers does not seem to implement MarshalProtoJSON.
...
func (x *GetApplicationPackageDefaultAssociationRequest) MarshalJSON() ([]byte, error) {
	return jsonplugin.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the GetApplicationPackageDefaultAssociationRequest message from JSON.
func (x *GetApplicationPackageDefaultAssociationRequest) UnmarshalProtoJSON(s *jsonplugin.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "ids":
			...
			// NOTE: ApplicationPackageDefaultAssociationIdentifiers does not seem to implement UnmarshalProtoJSON.
			var v ApplicationPackageDefaultAssociationIdentifiers
...
func (x *GetApplicationPackageDefaultAssociationRequest) UnmarshalJSON(b []byte) error {
	return jsonplugin.DefaultUnmarshalerConfig.Unmarshal(b, x)
}

// MarshalProtoJSON marshals the ListApplicationPackageDefaultAssociationRequest message to JSON.
func (x *ListApplicationPackageDefaultAssociationRequest) MarshalProtoJSON(s *jsonplugin.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
...
func (x *ListApplicationPackageDefaultAssociationRequest) MarshalJSON() ([]byte, error) {
	return jsonplugin.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the ListApplicationPackageDefaultAssociationRequest message from JSON.
func (x *ListApplicationPackageDefaultAssociationRequest) UnmarshalProtoJSON(s *jsonplugin.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
...
func (x *ListApplicationPackageDefaultAssociationRequest) UnmarshalJSON(b []byte) error {
	return jsonplugin.DefaultUnmarshalerConfig.Unmarshal(b, x)
}

// MarshalProtoJSON marshals the SetApplicationPackageDefaultAssociationRequest message to JSON.
func (x *SetApplicationPackageDefaultAssociationRequest) MarshalProtoJSON(s *jsonplugin.MarshalState) {
	if x == nil {
		s.WriteNil()
		return
	}
	s.WriteObjectStart()
	var wroteField bool
	if x.Default != nil || s.HasField("default") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("default")
		// NOTE: ApplicationPackageDefaultAssociation does not seem to implement MarshalProtoJSON.
		golang.MarshalMessage(s, x.Default)
	}
	if x.FieldMask != nil || s.HasField("field_mask") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("field_mask")
...
func (x *SetApplicationPackageDefaultAssociationRequest) MarshalJSON() ([]byte, error) {
	return jsonplugin.DefaultMarshalerConfig.Marshal(x)
}

// UnmarshalProtoJSON unmarshals the SetApplicationPackageDefaultAssociationRequest message from JSON.
func (x *SetApplicationPackageDefaultAssociationRequest) UnmarshalProtoJSON(s *jsonplugin.UnmarshalState) {
	if s.ReadNil() {
		return
	}
	s.ReadObject(func(key string) {
		...
		case "default":
			...
			// NOTE: ApplicationPackageDefaultAssociation does not seem to implement UnmarshalProtoJSON.
			var v ApplicationPackageDefaultAssociation
			golang.UnmarshalMessage(s, &v)
			x.Default = &v
		case "field_mask", "fieldMask":
			s.AddField("field_mask")
...
func (x *SetApplicationPackageDefaultAssociationRequest) UnmarshalJSON(b []byte) error {
	return jsonplugin.DefaultUnmarshalerConfig.Unmarshal(b, x)
}
