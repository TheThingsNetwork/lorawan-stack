...
type RxMetadata struct {
	...
	// Hopping width (grid) for LR-FHSS in kHz.
	HoppingWidth string `protobuf:"bytes,19,opt,name=hopping_width,json=hoppingWidth,proto3" json:"hopping_width,omitempty"`
...
func (m *RxMetadata) GetHoppingWidth() string {
	if m != nil {
...
var fileDescriptor_e1123b3e8fd87092 = []byte{
	...
	,
}
...
func (m *RxMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FrequencyDrift != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.FrequencyDrift))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	}
	if len(m.HoppingWidth) > 0 {
		i -= len(m.HoppingWidth)
		copy(dAtA[i:], m.HoppingWidth)
		i = encodeVarintMetadata(dAtA, i, uint64(len(m.HoppingWidth)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
...
func (m *RxMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HoppingWidth", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HoppingWidth = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FrequencyDrift", wireType)
			}
			m.FrequencyDrift = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FrequencyDrift |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
