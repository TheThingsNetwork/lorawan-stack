...
func (LocationSource) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_322387710711377e, []int{0}
}
...
type TxMetadata struct {
	...
	// If set, this field takes precedence over timestamp.
	Time *time.Time `protobuf:"bytes,3,opt,name=time,stdtime" json:"time,omitempty"`
	// Gateway concentrator timestamp when the downlink message should be transmitted (nanoseconds).
	// NOTE: most gateways use microsecond timestamps, so conversion may be needed.
	Timestamp uint64 `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	// Advanced metadata fields
	// - can be used for advanced information or experimental features that are not yet formally defined in the API
...
func (*TxMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_322387710711377e, []int{1}
}
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_322387710711377e, []int{2}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/metadata.proto", fileDescriptor_metadata_322387710711377e)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/metadata.proto", fileDescriptor_metadata_322387710711377e)
}

var fileDescriptor_metadata_322387710711377e = []byte{
	// 956 bytes of a gzipped FileDescriptorProto
	,
}
