...
type RxMetadata struct {
	...
	EncryptedFineTimestamp string `protobuf:"bytes,5,opt,name=encrypted_fine_timestamp,json=encryptedFineTimestamp,proto3" json:"encrypted_fine_timestamp,omitempty"`
	// Gateway's internal fine timestamp when the Rx finished (nanoseconds), decrypted.
	FineTimestampValue uint64 `protobuf:"varint,6,opt,name=fine_timestamp_value,json=fineTimestampValue,proto3" json:"fine_timestamp_value,omitempty"`
	// Real time
...
var fileDescriptorMetadata = []byte{
	...
	,
}
