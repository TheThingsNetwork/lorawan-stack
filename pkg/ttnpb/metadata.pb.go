...
type PacketBrokerMetadata struct {
	...
	ForwarderNetID go_thethings_network_lorawan_stack_pkg_types.NetID `protobuf:"bytes,2,opt,name=forwarder_net_id,json=forwarderNetId,proto3,customtype=go.thethings.network/lorawan-stack/pkg/types.NetID" json:"forwarder_net_id"`
	...
	HomeNetworkNetID go_thethings_network_lorawan_stack_pkg_types.NetID `protobuf:"bytes,5,opt,name=home_network_net_id,json=homeNetworkNetId,proto3,customtype=go.thethings.network/lorawan-stack/pkg/types.NetID" json:"home_network_net_id"`
...
var fileDescriptor_e1123b3e8fd87092 = []byte{
	...
	,
}
...
func NewPopulatedPacketBrokerMetadata(r randyMetadata, easy bool) *PacketBrokerMetadata {
	...
	v1 := go_thethings_network_lorawan_stack_pkg_types.NewPopulatedNetID(r)
	this.ForwarderNetID = *v1
	this.ForwarderTenantID = randStringMetadata(r)
	this.ForwarderID = randStringMetadata(r)
	v2 := go_thethings_network_lorawan_stack_pkg_types.NewPopulatedNetID(r)
