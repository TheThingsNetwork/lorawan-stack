...
func (LocationSource) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_0f843e9cd493eaab, []int{0}
}
...
type TxMetadata struct {
	// gateway_id is the ID of the gateway that received the message
	GatewayIdentifiers `protobuf:"bytes,1,opt,name=gateway_id,json=gatewayId,embedded=gateway_id" json:"gateway_id"`
	// Index of the antenna that should transmit the message
	AntennaIndex uint32 `protobuf:"varint,2,opt,name=antenna_index,json=antennaIndex,proto3" json:"antenna_index,omitempty"`
...
func (*TxMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_0f843e9cd493eaab, []int{1}
}
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_0f843e9cd493eaab, []int{2}
}
...
func (this *RxMetadata) String() string {
	...
	s := strings.Join([]string{`&RxMetadata{`,
		...
		`AESKeyID:` + fmt.Sprintf("%v", this.AESKeyID) + `,`,
...
func (this *TxMetadata) String() string {
	...
	s := strings.Join([]string{`&TxMetadata{`,
		...
		`InvertPolarity:` + fmt.Sprintf("%v", this.InvertPolarity) + `,`,
		`Advanced:` + strings.Replace(fmt.Sprintf("%v", this.Advanced), "Struct", "types.Struct", 1) + `,`,
		`}`,
	}, "")
	return s
...
func init() {
	proto.RegisterFile("lorawan-stack/api/metadata.proto", fileDescriptor_metadata_0f843e9cd493eaab)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/metadata.proto", fileDescriptor_metadata_0f843e9cd493eaab)
}

var fileDescriptor_metadata_0f843e9cd493eaab = []byte{
	...
	,
}
