...
func (*ProcessUplinkMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_services_3b702a4f872eaf5e, []int{0}
}
...
func (*ProcessDownlinkMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_services_3b702a4f872eaf5e, []int{1}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/message_services.proto", fileDescriptor_message_services_3b702a4f872eaf5e)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/message_services.proto", fileDescriptor_message_services_3b702a4f872eaf5e)
}

var fileDescriptor_message_services_3b702a4f872eaf5e = []byte{
