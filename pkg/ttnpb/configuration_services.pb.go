...
type BandDescription struct {
	...
	LoraCodingRate         string                                   `protobuf:"bytes,26,opt,name=lora_coding_rate,json=loraCodingRate,proto3" json:"lora_coding_rate,omitempty"`
	DefaultRx2Parameters   *BandDescription_Rx2Parameters           `protobuf:"bytes,31,opt,name=default_rx2_parameters,json=defaultRx2Parameters,proto3" json:"default_rx2_parameters,omitempty"`
	BootDwellTime          *BandDescription_DwellTime               `protobuf:"bytes,32,opt,name=boot_dwell_time,json=bootDwellTime,proto3" json:"boot_dwell_time,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                                 `json:"-"`
	XXX_unrecognized       []byte                                   `json:"-"`
	XXX_sizecache          int32                                    `json:"-"`
}
...
var fileDescriptor_2ed64f51a0283877 = []byte{
	...
	,
}
