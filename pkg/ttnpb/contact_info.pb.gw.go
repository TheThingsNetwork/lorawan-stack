...
// RegisterContactInfoRegistryHandler registers the http handlers for service ContactInfoRegistry to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "ContactInfoRegistryClient".
...
var (
	pattern_ContactInfoRegistry_Validate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"contact_info", "validate"}, ""))
)
