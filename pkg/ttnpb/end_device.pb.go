...
func (c *deviceRegistryClient) SetDevice(ctx context.Context, in *EndDevice, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
...
func (c *deviceRegistryClient) DeleteDevice(ctx context.Context, in *EndDeviceIdentifiers, opts ...grpc.CallOption) (*google_protobuf1.Empty, error) {
	out := new(google_protobuf1.Empty)
