...
func NewPopulatedEndDevice(r randyEndDevice, easy bool) *EndDevice {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.RecentUplinks = make([]*UplinkMessage, v10)
		for i := 0; i < v10; i++ {
	...
	if r.Intn(10) != 0 {
		v11 := r.Intn(5)
		this.RecentDownlinks = make([]*DownlinkMessage, v11)
		for i := 0; i < v11; i++ {
	...
	if r.Intn(10) != 0 {
		v12 := r.Intn(5)
		this.QueuedMACCommands = make([]*MACCommand, v12)
		for i := 0; i < v12; i++ {
...
var fileDescriptorEndDevice = []byte{
	...
	,
}
