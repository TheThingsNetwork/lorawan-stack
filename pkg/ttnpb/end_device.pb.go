...
func (PowerState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{0}
}
...
func (*MACParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{1}
}
...
func (*MACParameters_Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{1, 0}
}
...
func (*EndDeviceBrand) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{2}
}
...
func (*EndDeviceModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{3}
}
...
func (*EndDeviceVersionIdentifiers) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{4}
}
...
func (*EndDeviceVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{5}
}
...
func (*MACSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{6}
}
...
func (*MACState) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{7}
}
...
type EndDevice struct {
	...
	NetID *go_thethings_network_lorawan_stack_pkg_types.NetID `protobuf:"bytes,22,opt,name=net_id,json=netId,proto3,customtype=go.thethings.network/lorawan-stack/pkg/types.NetID" json:"net_id,omitempty"`
	// Settings for how the Network Server handles MAC for this device. Stored in Network Server.
	MACSettings *MACSettings `protobuf:"bytes,23,opt,name=mac_settings,json=macSettings" json:"mac_settings,omitempty"`
	// MAC state of the device. Stored in Network Server.
	MACState *MACState `protobuf:"bytes,24,opt,name=mac_state,json=macState" json:"mac_state,omitempty"`
	// Current session. Stored in Network Server.
	Session *Session `protobuf:"bytes,25,opt,name=session" json:"session,omitempty"`
	// Fallback session. Stored in Network Server until RekeyInd is received.
	SessionFallback *Session `protobuf:"bytes,26,opt,name=session_fallback,json=sessionFallback" json:"session_fallback,omitempty"`
	// Next DevNonce to be expected (in case of LoRaWAN 1.1).
	// Stored in Join Server.
	NextDevNonce uint32 `protobuf:"varint,27,opt,name=next_dev_nonce,json=nextDevNonce,proto3" json:"next_dev_nonce,omitempty"`
	// Used DevNonces (in case of LoRaWAN 1.0).
	// Stored in Join Server.
	UsedDevNonces []uint32 `protobuf:"varint,28,rep,packed,name=used_dev_nonces,json=usedDevNonces" json:"used_dev_nonces,omitempty"`
	// Next JoinNonce/AppNonce to be used (in case of LoRaWAN 1.1).
	// Stored in Join Server.
	NextJoinNonce uint32 `protobuf:"varint,29,opt,name=next_join_nonce,json=nextJoinNonce,proto3" json:"next_join_nonce,omitempty"`
	// Used JoinNonces/AppNonce (in case of LoRaWAN 1.0).
	// Stored in Join Server.
	UsedJoinNonces []uint32 `protobuf:"varint,30,rep,packed,name=used_join_nonces,json=usedJoinNonces" json:"used_join_nonces,omitempty"`
	// Next Rejoin counter (type 0/2) to be expected.
	// Stored in Join Server.
	NextRJCount0 uint32 `protobuf:"varint,31,opt,name=next_rj_count_0,json=nextRjCount0,proto3" json:"next_rj_count_0,omitempty"`
	// Next Rejoin counter (type 1) to be expected.
	// Stored in Join Server.
	NextRJCount1 uint32 `protobuf:"varint,32,opt,name=next_rj_count_1,json=nextRjCount1,proto3" json:"next_rj_count_1,omitempty"`
	// Number of messages, after which a new DevStatus MAC command shall be scheduled.
	// Stored in Network Server.
	NextStatusAfter uint64 `protobuf:"varint,33,opt,name=next_status_after,json=nextStatusAfter,proto3" json:"next_status_after,omitempty"`
	// Time when the device status was last received via the DevStatus MAC command.
	// Stored in Network Server.
	LastStatusReceivedAt *time.Time `protobuf:"bytes,34,opt,name=last_status_received_at,json=lastStatusReceivedAt,stdtime" json:"last_status_received_at,omitempty"`
	...
	// Stored in Network Server.
	BatteryPercentage float32 `protobuf:"fixed32,36,opt,name=battery_percentage,json=batteryPercentage,proto3" json:"battery_percentage,omitempty"`
	...
	RecentUplinks []*UplinkMessage `protobuf:"bytes,38,rep,name=recent_uplinks,json=recentUplinks" json:"recent_uplinks,omitempty"`
	// Recent downlink messages sorted by time. Stored in Network Server.
	// The number of messages stored may depend on configuration.
	RecentDownlinks []*DownlinkMessage `protobuf:"bytes,39,rep,name=recent_downlinks,json=recentDownlinks" json:"recent_downlinks,omitempty"`
	// Queued Application downlink messages. Stored in Application Server,
	// which sets them on the Network Server.
	QueuedApplicationDownlinks []*ApplicationDownlink `protobuf:"bytes,40,rep,name=queued_application_downlinks,json=queuedApplicationDownlinks" json:"queued_application_downlinks,omitempty"`
	...
	Formatters *MessagePayloadFormatters `protobuf:"bytes,41,opt,name=formatters" json:"formatters,omitempty"`
	// Location of the device. Stored in Application Server.
	Locations            map[string]*Location `protobuf:"bytes,42,rep,name=locations" json:"locations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*EndDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{8}
}
...
func (*EndDevices) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{9}
}
...
func (*CreateEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{10}
}
...
func (*UpdateEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{11}
}
...
func (*GetEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{12}
}
...
func (*ListEndDevicesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{13}
}
...
func (*SetDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_e93f0afe1f2e76b8, []int{14}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/end_device.proto", fileDescriptor_end_device_e93f0afe1f2e76b8)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/end_device.proto", fileDescriptor_end_device_e93f0afe1f2e76b8)
}

var fileDescriptor_end_device_e93f0afe1f2e76b8 = []byte{
	...
	,
}
