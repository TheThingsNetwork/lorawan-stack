...
func (PowerState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{0}
}
...
func (*MACParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{1}
}
...
func (*MACParameters_Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{1, 0}
}
...
func (*EndDeviceBrand) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{2}
}
...
func (*EndDeviceModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{3}
}
...
func (*EndDeviceVersionIdentifiers) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{4}
}
...
type EndDeviceVersion struct {
	...
	DefaultClass Class `protobuf:"varint,8,opt,name=default_class,json=defaultClass,proto3,enum=ttn.lorawan.v3.Class" json:"default_class,omitempty"`
	// Default MAC layer parameters, to which device is reset by default (e.g. on join or ResetInd).
	DefaultMACParameters *MACParameters `protobuf:"bytes,9,opt,name=default_mac_parameters,json=defaultMacParameters,proto3" json:"default_mac_parameters,omitempty"`
	...
	ResetsFCnt bool `protobuf:"varint,12,opt,name=resets_f_cnt,json=resetsFCnt,proto3" json:"resets_f_cnt,omitempty"`
	// Whether the device uses 32-bit frame counters.
	Uses32BitFCnt bool `protobuf:"varint,13,opt,name=uses_32_bit_f_cnt,json=uses32BitFCnt,proto3" json:"uses_32_bit_f_cnt,omitempty"`
	...
	ResetsJoinNonces bool `protobuf:"varint,15,opt,name=resets_join_nonces,json=resetsJoinNonces,proto3" json:"resets_join_nonces,omitempty"`
	// Default formatters defining the payload formats for this end device.
	DefaultFormatters    MessagePayloadFormatters `protobuf:"bytes,16,opt,name=default_formatters,json=defaultFormatters,proto3" json:"default_formatters"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (*EndDeviceVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{5}
}
...
func (m *EndDeviceVersion) GetDefaultClass() Class {
	if m != nil {
...
func (*MACSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{6}
}
...
func (*MACState) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{7}
}
...
func (*MACState_JoinAccept) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{7, 0}
}
...
type EndDevice struct {
	...
	// Default device class. Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	DefaultClass Class `protobuf:"varint,15,opt,name=default_class,json=defaultClass,proto3,enum=ttn.lorawan.v3.Class" json:"default_class,omitempty"`
	// LoRaWAN MAC version. Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	LoRaWANVersion MACVersion `protobuf:"varint,16,opt,name=lorawan_version,json=lorawanVersion,proto3,enum=ttn.lorawan.v3.MACVersion" json:"lorawan_version,omitempty"`
	// LoRaWAN PHY version. Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	LoRaWANPHYVersion PHYVersion `protobuf:"varint,17,opt,name=lorawan_phy_version,json=lorawanPhyVersion,proto3,enum=ttn.lorawan.v3.PHYVersion" json:"lorawan_phy_version,omitempty"`
	// ID of the frequency plan used by this device.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	FrequencyPlanID string `protobuf:"bytes,18,opt,name=frequency_plan_id,json=frequencyPlanId,proto3" json:"frequency_plan_id,omitempty"`
	// Default MAC layer parameters, to which device is reset by default (e.g. on join or ResetInd). Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	DefaultMACParameters *MACParameters `protobuf:"bytes,19,opt,name=default_mac_parameters,json=defaultMacParameters,proto3" json:"default_mac_parameters,omitempty"`
	// Minimum frequency the device is capable of using (Hz). Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	MinFrequency uint64 `protobuf:"varint,20,opt,name=min_frequency,json=minFrequency,proto3" json:"min_frequency,omitempty"`
	// Maximum frequency the device is capable of using (Hz). Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	MaxFrequency uint64 `protobuf:"varint,21,opt,name=max_frequency,json=maxFrequency,proto3" json:"max_frequency,omitempty"`
	// Whether the device resets the frame counters (not LoRaWAN compliant). Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	ResetsFCnt bool `protobuf:"varint,22,opt,name=resets_f_cnt,json=resetsFCnt,proto3" json:"resets_f_cnt,omitempty"`
	// Whether the device uses 32-bit frame counters. Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	Uses32BitFCnt bool `protobuf:"varint,23,opt,name=uses_32_bit_f_cnt,json=uses32BitFCnt,proto3" json:"uses_32_bit_f_cnt,omitempty"`
	// The device supports join (it's OTAA).
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	SupportsJoin bool `protobuf:"varint,24,opt,name=supports_join,json=supportsJoin,proto3" json:"supports_join,omitempty"`
	// Whether the device resets the join and dev nonces (not LoRaWAN 1.1 compliant). Stored in Network Server.
	// Copied on creation from template identified by version_ids, if any or from the home Network Server device profile, if any.
	ResetsJoinNonces bool `protobuf:"varint,25,opt,name=resets_join_nonces,json=resetsJoinNonces,proto3" json:"resets_join_nonces,omitempty"`
	// Device root keys. Stored in Join Server.
	RootKeys *RootKeys `protobuf:"bytes,26,opt,name=root_keys,json=rootKeys,proto3" json:"root_keys,omitempty"`
	// Home NetID. Stored in Join Server.
	NetID *go_thethings_network_lorawan_stack_pkg_types.NetID `protobuf:"bytes,27,opt,name=net_id,json=netId,proto3,customtype=go.thethings.network/lorawan-stack/pkg/types.NetID" json:"net_id,omitempty"`
	// Settings for how the Network Server handles MAC for this device. Stored in Network Server.
	MACSettings *MACSettings `protobuf:"bytes,28,opt,name=mac_settings,json=macSettings,proto3" json:"mac_settings,omitempty"`
	// MAC state of the device. Stored in Network Server.
	MACState *MACState `protobuf:"bytes,29,opt,name=mac_state,json=macState,proto3" json:"mac_state,omitempty"`
	// Current session of the device. Stored in Network Server and Application Server.
	Session *Session `protobuf:"bytes,30,opt,name=session,proto3" json:"session,omitempty"`
	// Pending session. Stored in Network Server and Application Server until RekeyInd is received.
	PendingSession *Session `protobuf:"bytes,31,opt,name=pending_session,json=pendingSession,proto3" json:"pending_session,omitempty"`
	// Last DevNonce used.
	// This field is only used for devices using LoRaWAN version 1.1 and later.
	// Stored in Join Server.
	LastDevNonce uint32 `protobuf:"varint,32,opt,name=last_dev_nonce,json=lastDevNonce,proto3" json:"last_dev_nonce,omitempty"`
	// Used DevNonces sorted in ascending order.
	// This field is only used for devices using LoRaWAN versions preceding 1.1.
	// Stored in Join Server.
	UsedDevNonces []uint32 `protobuf:"varint,33,rep,packed,name=used_dev_nonces,json=usedDevNonces,proto3" json:"used_dev_nonces,omitempty"`
	// Last JoinNonce/AppNonce(for devices using LoRaWAN versions preceding 1.1) used.
	// Stored in Join Server.
	LastJoinNonce uint32 `protobuf:"varint,34,opt,name=last_join_nonce,json=lastJoinNonce,proto3" json:"last_join_nonce,omitempty"`
	...
	LastDevStatusReceivedAt *time.Time `protobuf:"bytes,37,opt,name=last_dev_status_received_at,json=lastDevStatusReceivedAt,proto3,stdtime" json:"last_dev_status_received_at,omitempty"`
	...
	// Stored in Network Server.
	PowerState PowerState `protobuf:"varint,38,opt,name=power_state,json=powerState,proto3,enum=ttn.lorawan.v3.PowerState" json:"power_state,omitempty"`
	...
	// Stored in Network Server.
	BatteryPercentage float32 `protobuf:"fixed32,39,opt,name=battery_percentage,json=batteryPercentage,proto3" json:"battery_percentage,omitempty"`
	// Demodulation signal-to-noise ratio (dB).
	// Received via the DevStatus MAC command at last_dev_status_received_at.
	// Stored in Network Server.
	DownlinkMargin int32 `protobuf:"varint,40,opt,name=downlink_margin,json=downlinkMargin,proto3" json:"downlink_margin,omitempty"`
	...
	RecentADRUplinks []*UplinkMessage `protobuf:"bytes,41,rep,name=recent_adr_uplinks,json=recentAdrUplinks,proto3" json:"recent_adr_uplinks,omitempty"`
	// Recent uplink messages sorted by time. Stored in Network Server.
	// The number of messages stored may depend on configuration.
	RecentUplinks []*UplinkMessage `protobuf:"bytes,42,rep,name=recent_uplinks,json=recentUplinks,proto3" json:"recent_uplinks,omitempty"`
	// Recent downlink messages sorted by time. Stored in Network Server.
	// The number of messages stored may depend on configuration.
	RecentDownlinks []*DownlinkMessage `protobuf:"bytes,43,rep,name=recent_downlinks,json=recentDownlinks,proto3" json:"recent_downlinks,omitempty"`
	// Queued Application downlink messages. Stored in Application Server,
	// which sets them on the Network Server.
	QueuedApplicationDownlinks []*ApplicationDownlink `protobuf:"bytes,44,rep,name=queued_application_downlinks,json=queuedApplicationDownlinks,proto3" json:"queued_application_downlinks,omitempty"`
	...
	Formatters *MessagePayloadFormatters `protobuf:"bytes,45,opt,name=formatters,proto3" json:"formatters,omitempty"`
	// ID of the provisioner. Stored in Join Server.
	ProvisionerID string `protobuf:"bytes,46,opt,name=provisioner_id,json=provisionerId,proto3" json:"provisioner_id,omitempty"`
	// Vendor-specific provisioning data. Stored in Join Server.
	ProvisioningData     *types.Struct `protobuf:"bytes,47,opt,name=provisioning_data,json=provisioningData,proto3" json:"provisioning_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*EndDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{8}
}
...
func (m *EndDevice) GetDefaultClass() Class {
	if m != nil {
		return m.DefaultClass
	}
	return CLASS_A
...
func (*EndDevices) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{9}
}
...
func (*CreateEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{10}
}
...
func (*UpdateEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{11}
}
...
func (*GetEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{12}
}
...
func (*ListEndDevicesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{13}
}
...
func (*SetEndDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_end_device_90fb595206aae9a2, []int{14}
}
...
func (this *EndDeviceVersion) Equal(that interface{}) bool {
	...
	if this.DefaultClass != that1.DefaultClass {
		return false
	}
...
func (m *EndDeviceVersion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DefaultClass != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintEndDevice(dAtA, i, uint64(m.DefaultClass))
	}
...
func (m *MACState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.QueuedJoinAccept != nil {
		...
		n14, err := m.QueuedJoinAccept.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
	...
	if m.PendingJoinRequest != nil {
		...
		n15, err := m.PendingJoinRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *MACState_JoinAccept) MarshalTo(dAtA []byte) (int, error) {
	...
	n17, err := m.Keys.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n17
...
func (m *EndDevice) MarshalTo(dAtA []byte) (int, error) {
	...
	n20, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.UpdatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
	...
	if m.VersionIDs != nil {
		...
		n21, err := m.VersionIDs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.DefaultMACParameters != nil {
		...
		i++
		i = encodeVarintEndDevice(dAtA, i, uint64(m.DefaultMACParameters.Size()))
		n23, err := m.DefaultMACParameters.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.RootKeys != nil {
		...
		n24, err := m.RootKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.NetID != nil {
		...
		n25, err := m.NetID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.MACSettings != nil {
		...
		n26, err := m.MACSettings.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.MACState != nil {
		...
		n27, err := m.MACState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.PendingSession != nil {
		...
		n29, err := m.PendingSession.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if len(m.UsedDevNonces) > 0 {
		dAtA31 := make([]byte, len(m.UsedDevNonces)*10)
		var j30 int
	...
	if m.LastDevStatusReceivedAt != nil {
		...
		n32, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.LastDevStatusReceivedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.Formatters != nil {
		...
		n33, err := m.Formatters.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.ProvisioningData != nil {
		...
		n34, err := m.ProvisioningData.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *CreateEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n35, err := m.EndDevice.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
...
func (m *UpdateEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.EndDevice.Size()))
	n36, err := m.EndDevice.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	...
	n37, err := m.FieldMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
...
func (m *GetEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.EndDeviceIdentifiers.Size()))
	n38, err := m.EndDeviceIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.FieldMask.Size()))
	n39, err := m.FieldMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
...
func (m *ListEndDevicesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n40, err := m.ApplicationIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.FieldMask.Size()))
	n41, err := m.FieldMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
...
func (m *SetEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n42, err := m.Device.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func NewPopulatedMACState_JoinAccept(r randyEndDevice, easy bool) *MACState_JoinAccept {
	...
	v9 := NewPopulatedJoinRequest(r, easy)
	this.Request = *v9
...
func randFieldEndDevice(dAtA []byte, r randyEndDevice, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateEndDevice(dAtA, uint64(v22))
	case 1:
		dAtA = encodeVarintPopulateEndDevice(dAtA, uint64(key))
...
func (m *EndDeviceVersion) Size() (n int) {
	...
	if m.DefaultClass != 0 {
		n += 1 + sovEndDevice(uint64(m.DefaultClass))
	}
	if m.DefaultMACParameters != nil {
...
func (m *EndDevice) Size() (n int) {
	...
	if m.LoRaWANVersion != 0 {
		n += 2 + sovEndDevice(uint64(m.LoRaWANVersion))
	}
	if m.LoRaWANPHYVersion != 0 {
...
func (this *EndDeviceVersion) String() string {
	...
	s := strings.Join([]string{`&EndDeviceVersion{`,
		...
		`DefaultClass:` + fmt.Sprintf("%v", this.DefaultClass) + `,`,
...
func (m *EndDeviceVersion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultClass", wireType)
			}
			m.DefaultClass = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DefaultClass |= (Class(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/end_device.proto", fileDescriptor_end_device_90fb595206aae9a2)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/end_device.proto", fileDescriptor_end_device_90fb595206aae9a2)
}

var fileDescriptor_end_device_90fb595206aae9a2 = []byte{
	// 3457 bytes of a gzipped FileDescriptorProto
	,
}
