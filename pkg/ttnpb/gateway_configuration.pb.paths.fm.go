...
var UpdateManagedGatewayRequestFieldPathsNested = []string{
	...
	"gateway.capabilities.battery",
	"gateway.capabilities.cellular",
	"gateway.capabilities.ethernet",
	"gateway.capabilities.firmware_update",
	"gateway.capabilities.lora_8ch_concentrator",
	"gateway.capabilities.scan_wifi_access_points",
	"gateway.capabilities.wifi_2_4_ghz",
	"gateway.capabilities.wifi_5_ghz",
