...
func (*KeyEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_keys_3f530a9da05f7d9d, []int{0}
}
...
func (*RootKeys) Descriptor() ([]byte, []int) {
	return fileDescriptor_keys_3f530a9da05f7d9d, []int{1}
}
...
func (*SessionKeys) Descriptor() ([]byte, []int) {
	return fileDescriptor_keys_3f530a9da05f7d9d, []int{2}
}
...
func init() { proto.RegisterFile("lorawan-stack/api/keys.proto", fileDescriptor_keys_3f530a9da05f7d9d) }
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/keys.proto", fileDescriptor_keys_3f530a9da05f7d9d)
}

var fileDescriptor_keys_3f530a9da05f7d9d = []byte{
