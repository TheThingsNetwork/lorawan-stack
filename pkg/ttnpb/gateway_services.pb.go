...
var file_ttn_lorawan_v3_gateway_services_proto_depIdxs = []int32{
	...
	2,  // 23: ttn.lorawan.v3.GatewayBatchRegistry.Delete:input_type -> ttn.lorawan.v3.BatchDeleteGatewaysRequest
	18, // 24: ttn.lorawan.v3.GatewayRegistry.Create:output_type -> ttn.lorawan.v3.Gateway
	18, // 25: ttn.lorawan.v3.GatewayRegistry.Get:output_type -> ttn.lorawan.v3.Gateway
	3,  // 26: ttn.lorawan.v3.GatewayRegistry.GetIdentifiersForEUI:output_type -> ttn.lorawan.v3.GatewayIdentifiers
	19, // 27: ttn.lorawan.v3.GatewayRegistry.List:output_type -> ttn.lorawan.v3.Gateways
	18, // 28: ttn.lorawan.v3.GatewayRegistry.Update:output_type -> ttn.lorawan.v3.Gateway
	20, // 29: ttn.lorawan.v3.GatewayRegistry.Delete:output_type -> google.protobuf.Empty
	20, // 30: ttn.lorawan.v3.GatewayRegistry.Restore:output_type -> google.protobuf.Empty
	20, // 31: ttn.lorawan.v3.GatewayRegistry.Purge:output_type -> google.protobuf.Empty
	5,  // 32: ttn.lorawan.v3.GatewayAccess.ListRights:output_type -> ttn.lorawan.v3.Rights
	21, // 33: ttn.lorawan.v3.GatewayAccess.CreateAPIKey:output_type -> ttn.lorawan.v3.APIKey
	22, // 34: ttn.lorawan.v3.GatewayAccess.ListAPIKeys:output_type -> ttn.lorawan.v3.APIKeys
	21, // 35: ttn.lorawan.v3.GatewayAccess.GetAPIKey:output_type -> ttn.lorawan.v3.APIKey
	21, // 36: ttn.lorawan.v3.GatewayAccess.UpdateAPIKey:output_type -> ttn.lorawan.v3.APIKey
	23, // 37: ttn.lorawan.v3.GatewayAccess.GetCollaborator:output_type -> ttn.lorawan.v3.GetCollaboratorResponse
	20, // 38: ttn.lorawan.v3.GatewayAccess.SetCollaborator:output_type -> google.protobuf.Empty
	24, // 39: ttn.lorawan.v3.GatewayAccess.ListCollaborators:output_type -> ttn.lorawan.v3.Collaborators
	18, // 40: ttn.lorawan.v3.GatewayConfigurator.PullConfiguration:output_type -> ttn.lorawan.v3.Gateway
	20, // 41: ttn.lorawan.v3.GatewayBatchAccess.AssertRights:output_type -> google.protobuf.Empty
