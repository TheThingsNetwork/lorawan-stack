...
func (m *UserMask) Reset()                    { *m = UserMask{} }
func (m *UserMask) String() string            { return proto.CompactTextString(m) }
func (*UserMask) ProtoMessage()               {}
func (*UserMask) Descriptor() ([]byte, []int) { return fileDescriptorUser, []int{1} }

func (m *UserMask) GetEmail() bool {
	if m != nil {
		return m.Email
	}
	return false
...
func init() {
	...
	proto.RegisterType((*UserMask)(nil), "ttn.v3.UserMask")
	golang_proto.RegisterType((*UserMask)(nil), "ttn.v3.UserMask")
}
...
func (this *UserMask) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	that1, ok := that.(*UserMask)
	if !ok {
		that2, ok := that.(UserMask)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *UserMask")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *UserMask but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *UserMask but is not nil && this == nil")
	}
	if this.Email != that1.Email {
		return fmt.Errorf("Email this(%v) Not Equal that(%v)", this.Email, that1.Email)
	}
...
func (this *UserMask) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
...
func (m *UserMask) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UserMask) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func NewPopulatedUserMask(r randyUser, easy bool) *UserMask {
	this := &UserMask{}
	this.Email = bool(r.Intn(2) == 0)
...
func (m *UserMask) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UserMask: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UserMask: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorUser = []byte{
	...
	,
}
