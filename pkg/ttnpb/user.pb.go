...
var file_ttn_lorawan_v3_user_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbd, 0x0d, 0x0a, 0x16, 0x55, 0x73, 0x65,
	...
	0x72, 0x74, 0x42, 0x79, 0x1a, 0x86, 0x04, 0x0a, 0x10, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61,
	...
	0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x52, 0x0b, 0x2d, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x3a, 0x08,
	0xf2, 0xaa, 0x19, 0x04, 0x08, 0x01, 0x10, 0x01, 0x22, 0xd4, 0x0c, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x1a, 0x3d, 0x0a, 0x0f, 0x41, 0x74,
	...
	,
...
var file_ttn_lorawan_v3_user_proto_goTypes = []interface{}{
	...
	(*UserConsolePreferences)(nil),                  // 2: ttn.lorawan.v3.UserConsolePreferences
	(*User)(nil),                                    // 3: ttn.lorawan.v3.User
	(*Users)(nil),                                   // 4: ttn.lorawan.v3.Users
	(*GetUserRequest)(nil),                          // 5: ttn.lorawan.v3.GetUserRequest
	(*ListUsersRequest)(nil),                        // 6: ttn.lorawan.v3.ListUsersRequest
	(*CreateUserRequest)(nil),                       // 7: ttn.lorawan.v3.CreateUserRequest
	(*UpdateUserRequest)(nil),                       // 8: ttn.lorawan.v3.UpdateUserRequest
	(*CreateTemporaryPasswordRequest)(nil),          // 9: ttn.lorawan.v3.CreateTemporaryPasswordRequest
	(*UpdateUserPasswordRequest)(nil),               // 10: ttn.lorawan.v3.UpdateUserPasswordRequest
	(*ListUserAPIKeysRequest)(nil),                  // 11: ttn.lorawan.v3.ListUserAPIKeysRequest
	(*GetUserAPIKeyRequest)(nil),                    // 12: ttn.lorawan.v3.GetUserAPIKeyRequest
	(*CreateUserAPIKeyRequest)(nil),                 // 13: ttn.lorawan.v3.CreateUserAPIKeyRequest
	(*UpdateUserAPIKeyRequest)(nil),                 // 14: ttn.lorawan.v3.UpdateUserAPIKeyRequest
	(*DeleteUserAPIKeyRequest)(nil),                 // 15: ttn.lorawan.v3.DeleteUserAPIKeyRequest
	(*Invitation)(nil),                              // 16: ttn.lorawan.v3.Invitation
	(*ListInvitationsRequest)(nil),                  // 17: ttn.lorawan.v3.ListInvitationsRequest
	(*Invitations)(nil),                             // 18: ttn.lorawan.v3.Invitations
	(*SendInvitationRequest)(nil),                   // 19: ttn.lorawan.v3.SendInvitationRequest
	(*DeleteInvitationRequest)(nil),                 // 20: ttn.lorawan.v3.DeleteInvitationRequest
	(*UserSessionIdentifiers)(nil),                  // 21: ttn.lorawan.v3.UserSessionIdentifiers
	(*UserSession)(nil),                             // 22: ttn.lorawan.v3.UserSession
	(*UserSessions)(nil),                            // 23: ttn.lorawan.v3.UserSessions
	(*ListUserSessionsRequest)(nil),                 // 24: ttn.lorawan.v3.ListUserSessionsRequest
