...
func (PayloadFormatter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{0}
}
...
func (TxAcknowledgment_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{2, 0}
}
...
func (*DownlinkMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{1}
}
...
func (*TxAcknowledgment) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{2}
}
...
func (*ApplicationUplink) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{3}
}
...
func (*ApplicationLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{4}
}
...
func (*ApplicationJoinAccept) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{5}
}
...
func (*ApplicationDownlink) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{6}
}
...
func (*ApplicationDownlink_ClassBC) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{6, 0}
}
...
func (*ApplicationDownlink_ClassBC_GatewayAntennaIdentifiers) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{6, 0, 0}
}
...
func (*ApplicationDownlinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{7}
}
...
func (*ApplicationInvalidatedDownlinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{8}
}
...
func (*ApplicationUp) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{9}
}
...
type ApplicationUp_DownlinkQueueInvalidated struct {
	DownlinkQueueInvalidated *ApplicationInvalidatedDownlinks `protobuf:"bytes,9,opt,name=downlink_queue_invalidated,json=downlinkQueueInvalidated,oneof"`
}
type ApplicationUp_LocationSolved struct {
	LocationSolved *ApplicationLocation `protobuf:"bytes,10,opt,name=location_solved,json=locationSolved,oneof"`
}
...
func _ApplicationUp_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 8: // up.downlink_queued
		...
		return true, err
	case 9: // up.downlink_queue_invalidated
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
func (*MessagePayloadFormatters) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{10}
}
...
func (*DownlinkQueueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_c718dbdad4390041, []int{11}
}
...
func (m *ApplicationUp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Up != nil {
		nn17, err := m.Up.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn17
...
func (m *ApplicationUp_UplinkMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UplinkMessage != nil {
		...
		n18, err := m.UplinkMessage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *ApplicationUp_JoinAccept) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.JoinAccept != nil {
		...
		n19, err := m.JoinAccept.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *ApplicationUp_DownlinkAck) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DownlinkAck != nil {
		...
		n20, err := m.DownlinkAck.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ApplicationUp_DownlinkNack) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DownlinkNack != nil {
		...
		n21, err := m.DownlinkNack.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *ApplicationUp_DownlinkSent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DownlinkSent != nil {
		...
		n22, err := m.DownlinkSent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *ApplicationUp_DownlinkQueueInvalidated) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DownlinkQueueInvalidated != nil {
		...
		n24, err := m.DownlinkQueueInvalidated.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *ApplicationUp_LocationSolved) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LocationSolved != nil {
		...
		n25, err := m.LocationSolved.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *DownlinkQueueRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintMessages(dAtA, i, uint64(m.EndDeviceIdentifiers.Size()))
	n26, err := m.EndDeviceIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n26
...
func NewPopulatedApplicationUp(r randyMessages, easy bool) *ApplicationUp {
	...
	v12 := r.Intn(10)
	this.CorrelationIDs = make([]string, v12)
	for i := 0; i < v12; i++ {
		this.CorrelationIDs[i] = randStringMessages(r)
	}
	oneofNumber_Up := []int32{3, 4, 5, 6, 7, 8, 9, 10}[r.Intn(8)]
...
func init() {
	proto.RegisterFile("lorawan-stack/api/messages.proto", fileDescriptor_messages_c718dbdad4390041)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/messages.proto", fileDescriptor_messages_c718dbdad4390041)
}

var fileDescriptor_messages_c718dbdad4390041 = []byte{
	...
	,
}
