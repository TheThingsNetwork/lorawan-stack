...
type UserRegistrationSettings struct {
	...
	// Glob-style patterns of allowed email addresses. Matching addresses do not
	// require an invitation. Invitations can still be sent to other email addresses.
	AllowedEmailPatterns []string `protobuf:"bytes,4,rep,name=allowed_email_patterns,json=allowedEmailPatterns" json:"allowed_email_patterns,omitempty"`
...
func (*UserRegistrationSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_services_c24a80bd68fbd8f9, []int{0}
}
...
func (m *UserRegistrationSettings) GetAllowedEmailPatterns() []string {
	if m != nil {
		return m.AllowedEmailPatterns
	}
	return nil
}
...
func (*IdentityServerSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_services_c24a80bd68fbd8f9, []int{1}
}
...
func (*UpdateSettingsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_services_c24a80bd68fbd8f9, []int{2}
}
...
func (*FindEntitiesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_admin_services_c24a80bd68fbd8f9, []int{3}
}
...
func (this *UserRegistrationSettings) Equal(that interface{}) bool {
	...
	if len(this.AllowedEmailPatterns) != len(that1.AllowedEmailPatterns) {
		return false
	}
	for i := range this.AllowedEmailPatterns {
		if this.AllowedEmailPatterns[i] != that1.AllowedEmailPatterns[i] {
			return false
		}
	}
	return true
...
func (m *UserRegistrationSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AllowedEmailPatterns) > 0 {
		for _, s := range m.AllowedEmailPatterns {
			dAtA[i] = 0x22
			i++
			l = len(s)
			for l >= 1<<7 {
...
func NewPopulatedUserRegistrationSettings(r randyAdminServices, easy bool) *UserRegistrationSettings {
	...
	v1 := r.Intn(10)
	this.AllowedEmailPatterns = make([]string, v1)
	for i := 0; i < v1; i++ {
		this.AllowedEmailPatterns[i] = randStringAdminServices(r)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (this *UserRegistrationSettings) String() string {
	...
	s := strings.Join([]string{`&UserRegistrationSettings{`,
		...
		`AllowedEmailPatterns:` + fmt.Sprintf("%v", this.AllowedEmailPatterns) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *UserRegistrationSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedEmailPatterns", wireType)
			}
			...
			m.AllowedEmailPatterns = append(m.AllowedEmailPatterns, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func init() {
	proto.RegisterFile("lorawan-stack/api/admin_services.proto", fileDescriptor_admin_services_c24a80bd68fbd8f9)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/admin_services.proto", fileDescriptor_admin_services_c24a80bd68fbd8f9)
}

var fileDescriptor_admin_services_c24a80bd68fbd8f9 = []byte{
	// 1052 bytes of a gzipped FileDescriptorProto
	,
}
