...
type GetApplicationWebhookRequest struct {
	Ids                  ApplicationWebhookIdentifiers `protobuf:"bytes,1,opt,name=ids,proto3" json:"ids"`
...
func (m *GetApplicationWebhookRequest) GetIds() ApplicationWebhookIdentifiers {
	...
	return ApplicationWebhookIdentifiers{}
}
...
type SetApplicationWebhookRequest struct {
	Webhook              ApplicationWebhook `protobuf:"bytes,1,opt,name=webhook,proto3" json:"webhook"`
	FieldMask            *types.FieldMask   `protobuf:"bytes,2,opt,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type GetApplicationWebhookTemplateRequest struct {
	Ids                  ApplicationWebhookTemplateIdentifiers `protobuf:"bytes,1,opt,name=ids,proto3" json:"ids"`
	FieldMask            *types.FieldMask                      `protobuf:"bytes,2,opt,name=field_mask,json=fieldMask,proto3" json:"field_mask,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (m *GetApplicationWebhookTemplateRequest) GetIds() ApplicationWebhookTemplateIdentifiers {
	...
	return ApplicationWebhookTemplateIdentifiers{}
}
...
var fileDescriptor_2652f2d8eaceda0e = []byte{
	...
	,
}
...
func (this *GetApplicationWebhookRequest) String() string {
	...
	s := strings.Join([]string{`&GetApplicationWebhookRequest{`,
		`Ids:` + strings.Replace(strings.Replace(this.Ids.String(), "ApplicationWebhookIdentifiers", "ApplicationWebhookIdentifiers", 1), `&`, ``, 1) + `,`,
...
func (this *SetApplicationWebhookRequest) String() string {
	...
	s := strings.Join([]string{`&SetApplicationWebhookRequest{`,
		`Webhook:` + strings.Replace(strings.Replace(this.Webhook.String(), "ApplicationWebhook", "ApplicationWebhook", 1), `&`, ``, 1) + `,`,
		`FieldMask:` + strings.Replace(fmt.Sprintf("%v", this.FieldMask), "FieldMask", "types.FieldMask", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *GetApplicationWebhookTemplateRequest) String() string {
	...
	s := strings.Join([]string{`&GetApplicationWebhookTemplateRequest{`,
		`Ids:` + strings.Replace(strings.Replace(this.Ids.String(), "ApplicationWebhookTemplateIdentifiers", "ApplicationWebhookTemplateIdentifiers", 1), `&`, ``, 1) + `,`,
		`FieldMask:` + strings.Replace(fmt.Sprintf("%v", this.FieldMask), "FieldMask", "types.FieldMask", 1) + `,`,
		`}`,
	}, "")
	return s
