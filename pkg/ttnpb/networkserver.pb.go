...
type GsNsClient interface {
	StartServingGateway(ctx context.Context, in *GatewayIdentifiers, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
	StopServingGateway(ctx context.Context, in *GatewayIdentifiers, opts ...grpc.CallOption) (*google_protobuf2.Empty, error)
...
func (c *gsNsClient) StartServingGateway(ctx context.Context, in *GatewayIdentifiers, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
...
func (c *gsNsClient) StopServingGateway(ctx context.Context, in *GatewayIdentifiers, opts ...grpc.CallOption) (*google_protobuf2.Empty, error) {
	out := new(google_protobuf2.Empty)
...
type GsNsServer interface {
	StartServingGateway(context.Context, *GatewayIdentifiers) (*google_protobuf2.Empty, error)
	StopServingGateway(context.Context, *GatewayIdentifiers) (*google_protobuf2.Empty, error)
