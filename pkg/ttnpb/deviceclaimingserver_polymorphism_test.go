...
func TestAuthorizeRequests(t *testing.T) {
	...
	authorizeAppRequest := AuthorizeApplicationRequest{
		ApplicationIds: &ApplicationIdentifiers{
			ApplicationId: "foo",
		},
	}

	a.So(authorizeAppRequest.IDString(), should.Equal, "foo")
	...
	a.So(authorizeGatewayRequest.IDString(), should.Equal, "bar")
}
