...
func (m *FrequencyPlan_Channel) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Frequency != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintGatewayserver(dAtA, i, m.Frequency)
	}
	if m.DataRate != nil {
		dAtA[i] = 0x12
		i++
...
func (m *FrequencyPlan_Channel) Size() (n int) {
	...
	_ = l
	if m.Frequency != 0 {
		n += 1 + sovGatewayserver(m.Frequency)
	}
	if m.DataRate != nil {
		l = m.DataRate.Size()
		n += 1 + l + sovGatewayserver(uint64(l))
...
var fileDescriptorGatewayserver = []byte{
	...
	0xc4, 0x79, 0x98, 0x36, 0x93, 0x28, 0xa2, 0x1f, 0xca, 0x4c, 0xe1, 0x58, 0xe8, 0x2b, 0xab, 0x72,
	...
	,
}
