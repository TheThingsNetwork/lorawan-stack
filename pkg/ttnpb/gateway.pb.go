...
type Gateway struct {
	...
	// permantly disabled.
	// This a read-only field.
	ArchivedAt time.Time `protobuf:"bytes,14,opt,name=archived_at,json=archivedAt,stdtime" json:"archived_at"`
}
...
func (m *GatewayConfiguration_Radio) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TxConfiguration != nil {
		...
		n10, err := m.TxConfiguration.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func NewPopulatedGatewayConfiguration(r randyGateway, easy bool) *GatewayConfiguration {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v12; i++ {
			v13 := NewPopulatedGatewayConfiguration_GatewayAntennaConfiguration(r, easy)
			this.Antennas[i] = *v13
		}
	}
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.Radios = make([]GatewayConfiguration_Radio, v14)
		for i := 0; i < v14; i++ {
			v15 := NewPopulatedGatewayConfiguration_Radio(r, easy)
			this.Radios[i] = *v15
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedGatewayConfiguration_GatewayAntennaConfiguration(r randyGateway, easy bool) *GatewayConfiguration_GatewayAntennaConfiguration {
	...
	v16 := NewPopulatedLocation(r, easy)
	this.Location = *v16
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGatewayStatus(r randyGateway, easy bool) *GatewayStatus {
	...
	if r.Intn(10) != 0 {
		v18 := r.Intn(5)
		this.AntennasLocation = make([]*Location, v18)
		for i := 0; i < v18; i++ {
...
var fileDescriptorGateway = []byte{
	...
	,
}
