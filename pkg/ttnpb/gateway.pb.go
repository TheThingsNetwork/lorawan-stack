...
type Gateway struct {
	...
	// This value cannot be set/retrieved in Gateway API calls. Use the StoreGatewaySecret, RetrieveGatewaySecret requests.
	// It can however be deleted by DeleteGateway since it's part of the entity.
	Secrets              map[string]*Secret `protobuf:"bytes,22,rep,name=secrets,proto3" json:"secrets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *Gateway) GetSecrets() map[string]*Secret {
	if m != nil {
		return m.Secrets
	}
	return nil
...
type GatewayLBSLNSSecretPlainText struct {
	TokenKey             string   `protobuf:"bytes,1,opt,name=token_key,json=tokenKey,proto3" json:"token_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GatewayLBSLNSSecretPlainText) Reset()      { *m = GatewayLBSLNSSecretPlainText{} }
func (*GatewayLBSLNSSecretPlainText) ProtoMessage() {}
func (*GatewayLBSLNSSecretPlainText) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{22}
}
func (m *GatewayLBSLNSSecretPlainText) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GatewayLBSLNSSecretPlainText) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GatewayLBSLNSSecretPlainText.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GatewayLBSLNSSecretPlainText) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayLBSLNSSecretPlainText.Merge(m, src)
}
func (m *GatewayLBSLNSSecretPlainText) XXX_Size() int {
	return m.Size()
}
func (m *GatewayLBSLNSSecretPlainText) XXX_DiscardUnknown() {
	xxx_messageInfo_GatewayLBSLNSSecretPlainText.DiscardUnknown(m)
}

var xxx_messageInfo_GatewayLBSLNSSecretPlainText proto.InternalMessageInfo

func (m *GatewayLBSLNSSecretPlainText) GetTokenKey() string {
	if m != nil {
		return m.TokenKey
	}
	return ""
...
type GatewaySecrets struct {
	LBSLNSPlainText      *GatewayLBSLNSSecretPlainText `protobuf:"bytes,1,opt,name=lbs_lns_plain_text,json=lbsLnsPlainText,proto3" json:"lbs_lns_plain_text,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *GatewaySecrets) Reset()      { *m = GatewaySecrets{} }
func (*GatewaySecrets) ProtoMessage() {}
func (*GatewaySecrets) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{23}
}
func (m *GatewaySecrets) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GatewaySecrets) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GatewaySecrets.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GatewaySecrets) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewaySecrets.Merge(m, src)
}
func (m *GatewaySecrets) XXX_Size() int {
	return m.Size()
}
func (m *GatewaySecrets) XXX_DiscardUnknown() {
	xxx_messageInfo_GatewaySecrets.DiscardUnknown(m)
}

var xxx_messageInfo_GatewaySecrets proto.InternalMessageInfo

func (m *GatewaySecrets) GetLBSLNSPlainText() *GatewayLBSLNSSecretPlainText {
	if m != nil {
		return m.LBSLNSPlainText
	}
	return nil
}

type StoreGatewaySecretRequest struct {
	GatewayIdentifiers   `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,embedded=gateway_ids" json:"gateway_ids"`
	Secrets              *GatewaySecrets `protobuf:"bytes,2,opt,name=secrets,proto3" json:"secrets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *StoreGatewaySecretRequest) Reset()      { *m = StoreGatewaySecretRequest{} }
func (*StoreGatewaySecretRequest) ProtoMessage() {}
func (*StoreGatewaySecretRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{24}
}
func (m *StoreGatewaySecretRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StoreGatewaySecretRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StoreGatewaySecretRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StoreGatewaySecretRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StoreGatewaySecretRequest.Merge(m, src)
}
func (m *StoreGatewaySecretRequest) XXX_Size() int {
	return m.Size()
}
func (m *StoreGatewaySecretRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StoreGatewaySecretRequest.DiscardUnknown(m)
}

var xxx_messageInfo_StoreGatewaySecretRequest proto.InternalMessageInfo

func (m *StoreGatewaySecretRequest) GetSecrets() *GatewaySecrets {
	if m != nil {
		return m.Secrets
	}
	return nil
...
type RetrieveGatewaySecretRequest struct {
	GatewayIdentifiers   `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,embedded=gateway_ids" json:"gateway_ids"`
	Secrets              *GatewaySecrets `protobuf:"bytes,2,opt,name=secrets,proto3" json:"secrets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_sizecache        int32           `json:"-"`
...
func (m *RetrieveGatewaySecretRequest) Reset()      { *m = RetrieveGatewaySecretRequest{} }
func (*RetrieveGatewaySecretRequest) ProtoMessage() {}
func (*RetrieveGatewaySecretRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{25}
}
func (m *RetrieveGatewaySecretRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RetrieveGatewaySecretRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RetrieveGatewaySecretRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RetrieveGatewaySecretRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RetrieveGatewaySecretRequest.Merge(m, src)
}
func (m *RetrieveGatewaySecretRequest) XXX_Size() int {
	return m.Size()
}
func (m *RetrieveGatewaySecretRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RetrieveGatewaySecretRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RetrieveGatewaySecretRequest proto.InternalMessageInfo

func (m *RetrieveGatewaySecretRequest) GetSecrets() *GatewaySecrets {
	if m != nil {
		return m.Secrets
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*Secret)(nil), "ttn.lorawan.v3.Gateway.SecretsEntry")
	golang_proto.RegisterMapType((map[string]*Secret)(nil), "ttn.lorawan.v3.Gateway.SecretsEntry")
	...
	proto.RegisterType((*GatewayLBSLNSSecretPlainText)(nil), "ttn.lorawan.v3.GatewayLBSLNSSecretPlainText")
	golang_proto.RegisterType((*GatewayLBSLNSSecretPlainText)(nil), "ttn.lorawan.v3.GatewayLBSLNSSecretPlainText")
	proto.RegisterType((*GatewaySecrets)(nil), "ttn.lorawan.v3.GatewaySecrets")
	golang_proto.RegisterType((*GatewaySecrets)(nil), "ttn.lorawan.v3.GatewaySecrets")
	proto.RegisterType((*StoreGatewaySecretRequest)(nil), "ttn.lorawan.v3.StoreGatewaySecretRequest")
	golang_proto.RegisterType((*StoreGatewaySecretRequest)(nil), "ttn.lorawan.v3.StoreGatewaySecretRequest")
	proto.RegisterType((*RetrieveGatewaySecretRequest)(nil), "ttn.lorawan.v3.RetrieveGatewaySecretRequest")
	golang_proto.RegisterType((*RetrieveGatewaySecretRequest)(nil), "ttn.lorawan.v3.RetrieveGatewaySecretRequest")
}
...
var fileDescriptor_1df6bae1ac946b39 = []byte{
	...
	,
}
...
func (this *GatewayLBSLNSSecretPlainText) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GatewayLBSLNSSecretPlainText)
	if !ok {
		that2, ok := that.(GatewayLBSLNSSecretPlainText)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GatewaySecrets) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GatewaySecrets)
	if !ok {
		that2, ok := that.(GatewaySecrets)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.LBSLNSPlainText.Equal(that1.LBSLNSPlainText) {
		return false
	}
	return true
}
func (this *StoreGatewaySecretRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StoreGatewaySecretRequest)
	if !ok {
		that2, ok := that.(StoreGatewaySecretRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Secrets.Equal(that1.Secrets) {
		return false
	}
	return true
}
func (this *RetrieveGatewaySecretRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RetrieveGatewaySecretRequest)
	if !ok {
		that2, ok := that.(RetrieveGatewaySecretRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *GatewayLBSLNSSecretPlainText) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GatewayLBSLNSSecretPlainText) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GatewayLBSLNSSecretPlainText) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TokenKey) > 0 {
		...
		i = encodeVarintGateway(dAtA, i, uint64(len(m.TokenKey)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GatewaySecrets) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GatewaySecrets) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GatewaySecrets) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.LBSLNSPlainText != nil {
		{
			size, err := m.LBSLNSPlainText.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StoreGatewaySecretRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StoreGatewaySecretRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StoreGatewaySecretRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Secrets != nil {
		{
			size, err := m.Secrets.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RetrieveGatewaySecretRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RetrieveGatewaySecretRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RetrieveGatewaySecretRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedGateway(r randyGateway, easy bool) *Gateway {
	...
	if r.Intn(5) != 0 {
		v11 := r.Intn(10)
		this.Secrets = make(map[string]*Secret)
		for i := 0; i < v11; i++ {
			this.Secrets[randStringGateway(r)] = NewPopulatedSecret(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedGateways(r randyGateway, easy bool) *Gateways {
	...
	if r.Intn(5) != 0 {
		v12 := r.Intn(5)
		this.Gateways = make([]*Gateway, v12)
		for i := 0; i < v12; i++ {
...
func NewPopulatedUpdateGatewayRequest(r randyGateway, easy bool) *UpdateGatewayRequest {
	...
	v19 := NewPopulatedGateway(r, easy)
	this.Gateway = *v19
...
func NewPopulatedGatewayLBSLNSSecretPlainText(r randyGateway, easy bool) *GatewayLBSLNSSecretPlainText {
	this := &GatewayLBSLNSSecretPlainText{}
	this.TokenKey = randStringGateway(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedGatewaySecrets(r randyGateway, easy bool) *GatewaySecrets {
	this := &GatewaySecrets{}
	if r.Intn(5) != 0 {
		this.LBSLNSPlainText = NewPopulatedGatewayLBSLNSSecretPlainText(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedStoreGatewaySecretRequest(r randyGateway, easy bool) *StoreGatewaySecretRequest {
	this := &StoreGatewaySecretRequest{}
	v45 := NewPopulatedGatewayIdentifiers(r, easy)
	this.GatewayIdentifiers = *v45
	if r.Intn(5) != 0 {
		this.Secrets = NewPopulatedGatewaySecrets(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedRetrieveGatewaySecretRequest(r randyGateway, easy bool) *RetrieveGatewaySecretRequest {
	this := &RetrieveGatewaySecretRequest{}
...
func randFieldGateway(dAtA []byte, r randyGateway, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(v48))
	case 1:
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(key))
...
func (m *Gateway) Size() (n int) {
	...
	if len(m.Secrets) > 0 {
		for k, v := range m.Secrets {
			...
			n += mapEntrySize + 2 + sovGateway(uint64(mapEntrySize))
		}
	}
	return n
}
...
func (m *GatewayLBSLNSSecretPlainText) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GatewaySecrets) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.LBSLNSPlainText != nil {
		l = m.LBSLNSPlainText.Size()
		n += 1 + l + sovGateway(uint64(l))
	}
	return n
}

func (m *StoreGatewaySecretRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RetrieveGatewaySecretRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GatewayLBSLNSSecretPlainText) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GatewayLBSLNSSecretPlainText{`,
		`TokenKey:` + fmt.Sprintf("%v", this.TokenKey) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GatewaySecrets) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GatewaySecrets{`,
		`LBSLNSPlainText:` + strings.Replace(this.LBSLNSPlainText.String(), "GatewayLBSLNSSecretPlainText", "GatewayLBSLNSSecretPlainText", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StoreGatewaySecretRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&StoreGatewaySecretRequest{`,
		`GatewayIdentifiers:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.GatewayIdentifiers), "GatewayIdentifiers", "GatewayIdentifiers", 1), `&`, ``, 1) + `,`,
		`Secrets:` + strings.Replace(this.Secrets.String(), "GatewaySecrets", "GatewaySecrets", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RetrieveGatewaySecretRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RetrieveGatewaySecretRequest{`,
		`GatewayIdentifiers:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.GatewayIdentifiers), "GatewayIdentifiers", "GatewayIdentifiers", 1), `&`, ``, 1) + `,`,
		`Secrets:` + strings.Replace(this.Secrets.String(), "GatewaySecrets", "GatewaySecrets", 1) + `,`,
		`}`,
	}, "")
...
func (m *GatewayLBSLNSSecretPlainText) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GatewayLBSLNSSecretPlainText: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GatewayLBSLNSSecretPlainText: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GatewaySecrets) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GatewaySecrets: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GatewaySecrets: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LBSLNSPlainText", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LBSLNSPlainText == nil {
				m.LBSLNSPlainText = &GatewayLBSLNSSecretPlainText{}
			}
			if err := m.LBSLNSPlainText.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StoreGatewaySecretRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreGatewaySecretRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreGatewaySecretRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RetrieveGatewaySecretRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RetrieveGatewaySecretRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RetrieveGatewaySecretRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
