...
type LBSLNSSecret struct {
	TokenKey             string   `protobuf:"bytes,1,opt,name=token_key,json=tokenKey,proto3" json:"token_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *LBSLNSSecret) Reset()      { *m = LBSLNSSecret{} }
func (*LBSLNSSecret) ProtoMessage() {}
func (*LBSLNSSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{22}
}
func (m *LBSLNSSecret) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LBSLNSSecret) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LBSLNSSecret.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LBSLNSSecret) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LBSLNSSecret.Merge(m, src)
}
func (m *LBSLNSSecret) XXX_Size() int {
	return m.Size()
}
func (m *LBSLNSSecret) XXX_DiscardUnknown() {
	xxx_messageInfo_LBSLNSSecret.DiscardUnknown(m)
}

var xxx_messageInfo_LBSLNSSecret proto.InternalMessageInfo

func (m *LBSLNSSecret) GetTokenKey() string {
	if m != nil {
		return m.TokenKey
	}
	return ""
...
type GatewaySecret struct {
	...
	//	*GatewaySecret_LBSLNS
	Secret               isGatewaySecret_Secret `protobuf_oneof:"secret"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}

func (m *GatewaySecret) Reset()      { *m = GatewaySecret{} }
func (*GatewaySecret) ProtoMessage() {}
func (*GatewaySecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{23}
}
func (m *GatewaySecret) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GatewaySecret) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GatewaySecret.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GatewaySecret) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewaySecret.Merge(m, src)
}
func (m *GatewaySecret) XXX_Size() int {
	return m.Size()
}
func (m *GatewaySecret) XXX_DiscardUnknown() {
	xxx_messageInfo_GatewaySecret.DiscardUnknown(m)
}

var xxx_messageInfo_GatewaySecret proto.InternalMessageInfo

type isGatewaySecret_Secret interface {
	isGatewaySecret_Secret()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type GatewaySecret_LBSLNS struct {
	LBSLNS *LBSLNSSecret `protobuf:"bytes,1,opt,name=lbs_lns,json=lbsLns,proto3,oneof" json:"lbs_lns,omitempty"`
}

func (*GatewaySecret_LBSLNS) isGatewaySecret_Secret() {}

func (m *GatewaySecret) GetSecret() isGatewaySecret_Secret {
	if m != nil {
		return m.Secret
	}
	return nil
...
func (m *GatewaySecret) GetLBSLNS() *LBSLNSSecret {
	if x, ok := m.GetSecret().(*GatewaySecret_LBSLNS); ok {
		return x.LBSLNS
	}
	return nil
}
...
func (*GatewaySecret) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*GatewaySecret_LBSLNS)(nil),
	}
}

type StoreGatewaySecretRequest struct {
	GatewayIdentifiers   `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,embedded=gateway_ids" json:"gateway_ids"`
	Secret               *GatewaySecret `protobuf:"bytes,2,opt,name=secret,proto3" json:"secret,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *StoreGatewaySecretRequest) GetSecret() *GatewaySecret {
	if m != nil {
		return m.Secret
	}
	return nil
...
func (m *RetrieveGatewaySecretRequest) GetSecret() *GatewaySecret {
	if m != nil {
		return m.Secret
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LBSLNSSecret)(nil), "ttn.lorawan.v3.LBSLNSSecret")
	golang_proto.RegisterType((*LBSLNSSecret)(nil), "ttn.lorawan.v3.LBSLNSSecret")
	proto.RegisterType((*GatewaySecret)(nil), "ttn.lorawan.v3.GatewaySecret")
	golang_proto.RegisterType((*GatewaySecret)(nil), "ttn.lorawan.v3.GatewaySecret")
...
var fileDescriptor_1df6bae1ac946b39 = []byte{
	...
	,
}
...
func (this *LBSLNSSecret) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LBSLNSSecret)
	if !ok {
		that2, ok := that.(LBSLNSSecret)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GatewaySecret) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GatewaySecret)
	if !ok {
		that2, ok := that.(GatewaySecret)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.Secret == nil {
		...
		return false
	} else if !this.Secret.Equal(that1.Secret) {
		return false
	}
	return true
}
func (this *GatewaySecret_LBSLNS) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GatewaySecret_LBSLNS)
	if !ok {
		that2, ok := that.(GatewaySecret_LBSLNS)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.LBSLNS.Equal(that1.LBSLNS) {
		return false
	}
	return true
}
...
func (m *LBSLNSSecret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LBSLNSSecret) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LBSLNSSecret) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GatewaySecret) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GatewaySecret) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GatewaySecret) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GatewaySecret_LBSLNS) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GatewaySecret_LBSLNS) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.LBSLNS != nil {
		{
			size, err := m.LBSLNS.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func NewPopulatedLBSLNSSecret(r randyGateway, easy bool) *LBSLNSSecret {
	this := &LBSLNSSecret{}
...
func NewPopulatedGatewaySecret(r randyGateway, easy bool) *GatewaySecret {
	this := &GatewaySecret{}
	oneofNumber_Secret := []int32{1}[r.Intn(1)]
	switch oneofNumber_Secret {
	case 1:
		this.Secret = NewPopulatedGatewaySecret_LBSLNS(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedGatewaySecret_LBSLNS(r randyGateway, easy bool) *GatewaySecret_LBSLNS {
	this := &GatewaySecret_LBSLNS{}
	this.LBSLNS = NewPopulatedLBSLNSSecret(r, easy)
	return this
}
func NewPopulatedStoreGatewaySecretRequest(r randyGateway, easy bool) *StoreGatewaySecretRequest {
	...
	if r.Intn(5) != 0 {
		this.Secret = NewPopulatedGatewaySecret(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *LBSLNSSecret) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GatewaySecret) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GatewaySecret_LBSLNS) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *LBSLNSSecret) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LBSLNSSecret{`,
		`TokenKey:` + fmt.Sprintf("%v", this.TokenKey) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GatewaySecret) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GatewaySecret{`,
		`Secret:` + fmt.Sprintf("%v", this.Secret) + `,`,
		`}`,
	}, "")
	return s
}
func (this *GatewaySecret_LBSLNS) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GatewaySecret_LBSLNS{`,
		`LBSLNS:` + strings.Replace(fmt.Sprintf("%v", this.LBSLNS), "LBSLNSSecret", "LBSLNSSecret", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *StoreGatewaySecretRequest) String() string {
	...
	s := strings.Join([]string{`&StoreGatewaySecretRequest{`,
		`GatewayIdentifiers:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.GatewayIdentifiers), "GatewayIdentifiers", "GatewayIdentifiers", 1), `&`, ``, 1) + `,`,
		`Secret:` + strings.Replace(this.Secret.String(), "GatewaySecret", "GatewaySecret", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LBSLNSSecret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LBSLNSSecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LBSLNSSecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GatewaySecret) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GatewaySecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GatewaySecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LBSLNS", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Secret = &GatewaySecret_LBSLNS{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(dAtA[iNdEx:])
