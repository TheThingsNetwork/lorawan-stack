...
type Gateway struct {
	...
	// when they are added.
	ContactAccount *UserIdentifier `protobuf:"bytes,12,opt,name=contact_account,json=contactAccount" json:"contact_account,omitempty"`
...
type GatewayObservations struct {
	...
	LastUplinkReceived time.Time `protobuf:"bytes,1,opt,name=last_uplink_received,json=lastUplinkReceived,stdtime" json:"last_uplink_received"`
	...
	LastDownlinkReceived time.Time `protobuf:"bytes,3,opt,name=last_downlink_received,json=lastDownlinkReceived,stdtime" json:"last_downlink_received"`
	...
	LastStatusReceived time.Time `protobuf:"bytes,5,opt,name=last_status_received,json=lastStatusReceived,stdtime" json:"last_status_received"`
...
func (this *GatewayObservations) VerboseEqual(that interface{}) error {
	...
	if !this.LastUplinkReceived.Equal(that1.LastUplinkReceived) {
	...
	if !this.LastDownlinkReceived.Equal(that1.LastDownlinkReceived) {
	...
	if !this.LastStatusReceived.Equal(that1.LastStatusReceived) {
...
func randFieldGateway(dAtA []byte, r randyGateway, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(v23))
	case 1:
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(key))
...
var fileDescriptorGateway = []byte{
	...
	,
}
