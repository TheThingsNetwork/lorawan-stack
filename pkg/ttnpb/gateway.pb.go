...
func NewPopulatedGatewayStatus(r randyGateway, easy bool) *GatewayStatus {
	...
	if r.Intn(10) != 0 {
		v13 := r.Intn(5)
		this.AntennasLocation = make([]*Location, v13)
		for i := 0; i < v13; i++ {
			this.AntennasLocation[i] = NewPopulatedLocation(r, easy)
		}
	}
	v14 := r.Intn(10)
	this.IP = make([]string, v14)
	for i := 0; i < v14; i++ {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v15; i++ {
			v16 := randStringGateway(r)
			this.Metrics[v16] = r.Float32()
			if r.Intn(2) == 0 {
				this.Metrics[v16] *= -1
			}
		}
...
func randFieldGateway(dAtA []byte, r randyGateway, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(v18))
	case 1:
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(key))
...
var fileDescriptorGateway = []byte{
	...
	,
	...
	0x95, 0x27, 0x23, 0xac, 0x1c, 0x8d, 0x30, 0x78, 0x36, 0xc2, 0xca, 0xf3, 0x11, 0x06, 0xbf, 0x8e,
	0xb0, 0xf2, 0x62, 0x84, 0x95, 0x97, 0x23, 0x0c, 0x5e, 0x8d, 0x30, 0x78, 0x3d, 0xc2, 0xe0, 0xa7,
	0xff, 0x7f, 0xee, 0xff, 0x65, 0x77, 0xbf, 0x13, 0xfd, 0x75, 0xdb, 0xed, 0x2c, 0x6f, 0xfc, 0xf5,
	0xbf, 0x03, 0x00, 0x00, 0xff, 0xff, 0xe5, 0x74, 0x1f, 0x5e, 0x01, 0x0c, 0x00, 0x00,
}
