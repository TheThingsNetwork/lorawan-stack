...
type Gateway struct {
	...
	// An encypted secret value for this gateway.
	// When set, this is currently sent as the lnsKey parameter in the Basic Station CUPS response. This can also be extended to store other values such as client TLS private key.
	...
	Secret               []byte   `protobuf:"bytes,22,opt,name=secret,proto3" json:"secret,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type GatewaySecretPlainText struct {
	Value                string   `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GatewaySecretPlainText) Reset()      { *m = GatewaySecretPlainText{} }
func (*GatewaySecretPlainText) ProtoMessage() {}
func (*GatewaySecretPlainText) Descriptor() ([]byte, []int) {
	return fileDescriptor_1df6bae1ac946b39, []int{22}
}
func (m *GatewaySecretPlainText) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GatewaySecretPlainText) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GatewaySecretPlainText.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GatewaySecretPlainText) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewaySecretPlainText.Merge(m, src)
}
func (m *GatewaySecretPlainText) XXX_Size() int {
	return m.Size()
}
func (m *GatewaySecretPlainText) XXX_DiscardUnknown() {
	xxx_messageInfo_GatewaySecretPlainText.DiscardUnknown(m)
}

var xxx_messageInfo_GatewaySecretPlainText proto.InternalMessageInfo

func (m *GatewaySecretPlainText) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type StoreGatewaySecretRequest struct {
	GatewayIdentifiers   `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,embedded=gateway_ids" json:"gateway_ids"`
	PlainText            GatewaySecretPlainText `protobuf:"bytes,2,opt,name=plain_text,json=plainText,proto3" json:"plain_text"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *StoreGatewaySecretRequest) GetPlainText() GatewaySecretPlainText {
	if m != nil {
		return m.PlainText
	}
	return GatewaySecretPlainText{}
}

type RetrieveGatewaySecretRequest struct {
	GatewayIdentifiers   `protobuf:"bytes,1,opt,name=gateway_ids,json=gatewayIds,proto3,embedded=gateway_ids" json:"gateway_ids"`
	PlainText            *GatewaySecretPlainText `protobuf:"bytes,2,opt,name=plain_text,json=plainText,proto3" json:"plain_text,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *RetrieveGatewaySecretRequest) GetPlainText() *GatewaySecretPlainText {
	if m != nil {
		return m.PlainText
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GatewaySecretPlainText)(nil), "ttn.lorawan.v3.GatewaySecretPlainText")
	golang_proto.RegisterType((*GatewaySecretPlainText)(nil), "ttn.lorawan.v3.GatewaySecretPlainText")
...
var fileDescriptor_1df6bae1ac946b39 = []byte{
	...
	,
}
...
func (this *GatewaySecretPlainText) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GatewaySecretPlainText)
	if !ok {
		that2, ok := that.(GatewaySecretPlainText)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *StoreGatewaySecretRequest) Equal(that interface{}) bool {
	...
	if !this.PlainText.Equal(&that1.PlainText) {
		return false
	}
	return true
}
...
func (m *Gateway) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Secret) > 0 {
		...
		i = encodeVarintGateway(dAtA, i, uint64(len(m.Secret)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
...
func (m *GatewaySecretPlainText) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GatewaySecretPlainText) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GatewaySecretPlainText) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedGatewaySecretPlainText(r randyGateway, easy bool) *GatewaySecretPlainText {
	this := &GatewaySecretPlainText{}
	this.Value = randStringGateway(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedStoreGatewaySecretRequest(r randyGateway, easy bool) *StoreGatewaySecretRequest {
	...
	v46 := NewPopulatedGatewaySecretPlainText(r, easy)
	this.PlainText = *v46
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedRetrieveGatewaySecretRequest(r randyGateway, easy bool) *RetrieveGatewaySecretRequest {
	...
	v47 := NewPopulatedGatewayIdentifiers(r, easy)
	this.GatewayIdentifiers = *v47
	if r.Intn(5) != 0 {
		this.PlainText = NewPopulatedGatewaySecretPlainText(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldGateway(dAtA []byte, r randyGateway, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(v49))
	case 1:
		dAtA = encodeVarintPopulateGateway(dAtA, uint64(key))
...
func (m *GatewaySecretPlainText) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GatewaySecretPlainText) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GatewaySecretPlainText{`,
...
func (this *StoreGatewaySecretRequest) String() string {
	...
	s := strings.Join([]string{`&StoreGatewaySecretRequest{`,
		`GatewayIdentifiers:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.GatewayIdentifiers), "GatewayIdentifiers", "GatewayIdentifiers", 1), `&`, ``, 1) + `,`,
		`PlainText:` + strings.Replace(strings.Replace(this.PlainText.String(), "GatewaySecretPlainText", "GatewaySecretPlainText", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RetrieveGatewaySecretRequest) String() string {
	...
	s := strings.Join([]string{`&RetrieveGatewaySecretRequest{`,
		`GatewayIdentifiers:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.GatewayIdentifiers), "GatewayIdentifiers", "GatewayIdentifiers", 1), `&`, ``, 1) + `,`,
		`PlainText:` + strings.Replace(this.PlainText.String(), "GatewaySecretPlainText", "GatewaySecretPlainText", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *GatewaySecretPlainText) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GatewaySecretPlainText: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GatewaySecretPlainText: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RetrieveGatewaySecretRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PlainText == nil {
				m.PlainText = &GatewaySecretPlainText{}
			}
			if err := m.PlainText.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
