...
type Gateway struct {
	...
	ArchivedAt *time.Time `protobuf:"bytes,13,opt,name=archived_at,json=archivedAt,stdtime" json:"archived_at,omitempty"`
}
...
// of the gateway such as if the owner information or location are public.
...
func (m *GatewayConfiguration_Radio) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TXConfig != nil {
		...
		n8, err := m.TXConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
var fileDescriptorGateway = []byte{
	...
	,
}
