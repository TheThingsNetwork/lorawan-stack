...
type Gateway struct {
	...
	// By default, the Gateway Server only sends downlinks to gateways right before
	// emission time. You can opt a gateway out by setting this field to `true`.
	DisableTxDelay bool `protobuf:"varint,15,opt,name=disable_tx_delay,json=disableTxDelay,proto3" json:"disable_tx_delay,omitempty"`
}
...
func (m *Gateway) GetDisableTxDelay() bool {
	if m != nil {
		return m.DisableTxDelay
	}
	return false
}
...
func init() {
	...
	proto.RegisterType((*GatewayObservations)(nil), "ttn.lorawan.v3.GatewayObservations")
	golang_proto.RegisterType((*GatewayObservations)(nil), "ttn.lorawan.v3.GatewayObservations")
...
func (this *Gateway) VerboseEqual(that interface{}) error {
	...
	if this.DisableTxDelay != that1.DisableTxDelay {
		return fmt.Errorf("DisableTxDelay this(%v) Not Equal that(%v)", this.DisableTxDelay, that1.DisableTxDelay)
	}
	return nil
}
...
func NewPopulatedGateway(r randyGateway, easy bool) *Gateway {
	...
	if r.Intn(10) != 0 {
		this.ActivatedAt = types.NewPopulatedStdTime(r, easy)
	}
	...
	this.UpdatedAt = *v9
	this.DisableTxDelay = bool(bool(r.Intn(2) == 0))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedGatewayStatus(r randyGateway, easy bool) *GatewayStatus {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v16; i++ {
			...
			this.Metrics[v17] = float32(r.Float32())
			if r.Intn(2) == 0 {
				this.Metrics[v17] *= -1
			}
		}
...
func (m *Gateway) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableTxDelay", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() {
	proto.RegisterFile("go.thethings.network/lorawan-stack/api/gateway.proto", fileDescriptorGateway)
}
func init() {
	golang_proto.RegisterFile("go.thethings.network/lorawan-stack/api/gateway.proto", fileDescriptorGateway)
}

var fileDescriptorGateway = []byte{
	// 1412 bytes of a gzipped FileDescriptorProto
	,
}
