...
type Gateway struct {
	...
	GatewayIdentifiers `protobuf:"bytes,1,opt,name=id,embedded=id" json:""`
	...
	ContactAccount *OrganizationOrUserIdentifiers `protobuf:"bytes,12,opt,name=contact_account,json=contactAccount" json:"contact_account,omitempty"`
...
func (m *Gateway) GetContactAccount() *OrganizationOrUserIdentifiers {
	if m != nil {
...
func NewPopulatedGateway(r randyGateway, easy bool) *Gateway {
	...
	if r.Intn(10) != 0 {
		this.ContactAccount = NewPopulatedOrganizationOrUserIdentifiers(r, easy)
	}
...
func (m *Gateway) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			if m.ContactAccount == nil {
				m.ContactAccount = &OrganizationOrUserIdentifiers{}
			}
...
var fileDescriptorGateway = []byte{
	...
	,
}
