...
var _regex_ApplicationWebhookIdentifiers_WebhookID = regexp.MustCompile(`^[a-z0-9](?:[-]?[a-z0-9]){2,}$`)
...
func (this *ApplicationWebhookIdentifiers) Validate() error {
	...
	if !_regex_ApplicationWebhookIdentifiers_WebhookID.MatchString(this.WebhookID) {
		return github_com_mwitkow_go_proto_validators.FieldError("WebhookID", fmt.Errorf(`value '%v' must be a string conforming to regex "^[a-z0-9](?:[-]?[a-z0-9]){2,}$"`, this.WebhookID))
	}
