...
type RejoinTimePeriod int32

const (
	// Every ~17.1 minutes
	REJOIN_TIME_0 RejoinTimePeriod = 0
	// Every ~34.1 minutes
	REJOIN_TIME_1 RejoinTimePeriod = 1
	// Every ~1.1 hours
	REJOIN_TIME_2 RejoinTimePeriod = 2
	// Every ~2.3 hours
	REJOIN_TIME_3 RejoinTimePeriod = 3
	// Every ~4.6 hours
	REJOIN_TIME_4 RejoinTimePeriod = 4
	// Every ~9.1 hours
	REJOIN_TIME_5 RejoinTimePeriod = 5
	// Every ~18.2 hours
	REJOIN_TIME_6 RejoinTimePeriod = 6
	// Every ~1.5 days
	REJOIN_TIME_7 RejoinTimePeriod = 7
	// Every ~3.0 days
	REJOIN_TIME_8 RejoinTimePeriod = 8
	// Every ~6.1 days
	REJOIN_TIME_9 RejoinTimePeriod = 9
	// Every ~12.1 days
	REJOIN_TIME_10 RejoinTimePeriod = 10
	// Every ~3.5 weeks
	REJOIN_TIME_11 RejoinTimePeriod = 11
	// Every ~1.6 months
	REJOIN_TIME_12 RejoinTimePeriod = 12
	// Every ~3.2 months
	REJOIN_TIME_13 RejoinTimePeriod = 13
	// Every ~6.4 months
	REJOIN_TIME_14 RejoinTimePeriod = 14
	// Every ~1.1 year
	REJOIN_TIME_15 RejoinTimePeriod = 15
)

var RejoinTimePeriod_name = map[int32]string{
	0:  "REJOIN_TIME_0",
	1:  "REJOIN_TIME_1",
	2:  "REJOIN_TIME_2",
	3:  "REJOIN_TIME_3",
...
var RejoinTimePeriod_value = map[string]int32{
	"REJOIN_TIME_0":  0,
	"REJOIN_TIME_1":  1,
	"REJOIN_TIME_2":  2,
	"REJOIN_TIME_3":  3,
...
func (RejoinTimePeriod) EnumDescriptor() ([]byte, []int) { return fileDescriptorLorawan, []int{11} }
...
func (DeviceEIRP) EnumDescriptor() ([]byte, []int) { return fileDescriptorLorawan, []int{12} }
...
func (ADRAckLimitExponent) EnumDescriptor() ([]byte, []int) { return fileDescriptorLorawan, []int{13} }
...
func (ADRAckDelayExponent) EnumDescriptor() ([]byte, []int) { return fileDescriptorLorawan, []int{14} }
...
func init() {
	...
	proto.RegisterEnum("ttn.lorawan.v3.RejoinTimePeriod", RejoinTimePeriod_name, RejoinTimePeriod_value)
	golang_proto.RegisterEnum("ttn.lorawan.v3.RejoinTimePeriod", RejoinTimePeriod_name, RejoinTimePeriod_value)
...
func (x RejoinTimePeriod) String() string {
	s, ok := RejoinTimePeriod_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
var fileDescriptorLorawan = []byte{
	...
	,
}
