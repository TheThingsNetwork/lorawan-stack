...
func NewPopulatedMessage(r randyLorawan, easy bool) *Message {
	...
	oneofNumber_Payload := []int32{3, 4, 5, 6}[r.Intn(4)]
	...
	case 6:
		this.Payload = NewPopulatedMessage_RejoinRequestPayload(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedMessage_RejoinRequestPayload(r randyLorawan, easy bool) *Message_RejoinRequestPayload {
	this := &Message_RejoinRequestPayload{}
	this.RejoinRequestPayload = NewPopulatedRejoinRequestPayload(r, easy)
	return this
}
...
func NewPopulatedFHDR(r randyLorawan, easy bool) *FHDR {
	this := &FHDR{}
	v5 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedDevAddr(r)
	this.DevAddr = *v5
	v6 := NewPopulatedFCtrl(r, easy)
	this.FCtrl = *v6
	this.FCnt = uint32(r.Uint32())
	v7 := r.Intn(100)
	this.FOpts = make([]byte, v7)
	for i := 0; i < v7; i++ {
		this.FOpts[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedJoinRequestPayload(r randyLorawan, easy bool) *JoinRequestPayload {
	...
	v8 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedEUI64(r)
	this.JoinEUI = *v8
	v9 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedEUI64(r)
	this.DevEUI = *v9
	v10 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedDevNonce(r)
	this.DevNonce = *v10
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedRejoinRequestPayload(r randyLorawan, easy bool) *RejoinRequestPayload {
	this := &RejoinRequestPayload{}
	this.RejoinType = RejoinType([]int32{0, 1, 2}[r.Intn(3)])
	v11 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedNetID(r)
	this.NetID = *v11
	v12 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedEUI64(r)
	this.JoinEUI = *v12
	v13 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedEUI64(r)
	this.DevEUI = *v13
	this.RejoinCnt = uint32(r.Uint32())
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedJoinAcceptPayload(r randyLorawan, easy bool) *JoinAcceptPayload {
	...
	v14 := r.Intn(100)
	this.Encrypted = make([]byte, v14)
	for i := 0; i < v14; i++ {
		this.Encrypted[i] = byte(r.Intn(256))
	}
	v15 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedJoinNonce(r)
	this.JoinNonce = *v15
	v16 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedNetID(r)
	this.NetID = *v16
	v17 := github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedDevAddr(r)
	this.DevAddr = *v17
	v18 := NewPopulatedDLSettings(r, easy)
	this.DLSettings = *v18
...
func randFieldLorawan(dAtA []byte, r randyLorawan, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateLorawan(dAtA, uint64(v21))
	case 1:
		dAtA = encodeVarintPopulateLorawan(dAtA, uint64(key))
...
var fileDescriptorLorawan = []byte{
	...
	,
}
