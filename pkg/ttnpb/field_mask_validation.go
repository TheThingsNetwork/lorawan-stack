...
var AllowedFieldMaskPathsForRPC = map[string][]string{
	...
	"/ttn.lorawan.v3.ApplicationActivationSettingRegistry/Get":    ApplicationActivationSettingsFieldPathsNested,
	"/ttn.lorawan.v3.ApplicationActivationSettingRegistry/Set":    ApplicationActivationSettingsFieldPathsNested,
	"/ttn.lorawan.v3.ApplicationActivationSettingRegistry/Delete": ApplicationActivationSettingsFieldPathsNested,
	...
	"/ttn.lorawan.v3.NsEndDeviceRegistry/Get": nsEndDeviceReadFieldPaths[:],
	...
	// Gateways:
	"/ttn.lorawan.v3.EntityRegistrySearch/SearchGateways": omitFields(GatewayFieldPathsNested,
	...
	"/ttn.lorawan.v3.GatewayRegistry/Get": omitFields(GatewayFieldPathsNested,
		"gateway.claim_authentication_code.secret",
		"gateway.claim_authentication_code.secret.key_id",
		"gateway.claim_authentication_code.secret.value",
		"gateway.claim_authentication_code.valid_from",
		"gateway.claim_authentication_code.valid_to"),
	"/ttn.lorawan.v3.GatewayRegistry/List": omitFields(GatewayFieldPathsNested,
		"gateway.claim_authentication_code.secret",
		"gateway.claim_authentication_code.secret.key_id",
		"gateway.claim_authentication_code.secret.value",
		"gateway.claim_authentication_code.valid_from",
		"gateway.claim_authentication_code.valid_to"),
	"/ttn.lorawan.v3.GatewayRegistry/Update": omitFields(GatewayFieldPathsNested,
		"gateway.claim_authentication_code.secret",
		"gateway.claim_authentication_code.secret.key_id",
		"gateway.claim_authentication_code.secret.value",
		"gateway.claim_authentication_code.valid_from",
