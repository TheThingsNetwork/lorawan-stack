...
func AddSelectFlagsForApplication(flags *pflag.FlagSet, prefix string, hidden bool) {
	...
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("dev-eui-counter", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("dev-eui-counter", prefix), false), flagsplugin.WithHidden(hidden)))
}
...
func AddSetFlagsForApplication(flags *pflag.FlagSet, prefix string, hidden bool) {
	AddSetFlagsForApplicationIdentifiers(flags, flagsplugin.Prefix("ids", prefix), true)
