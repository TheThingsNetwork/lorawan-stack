...
type GatewayIdentifiers struct {
	...
	EUI *github_com_TheThingsNetwork_ttn_pkg_types.EUI64 `protobuf:"bytes,2,opt,name=eui,proto3,customtype=github.com/TheThingsNetwork/ttn/pkg/types.EUI64" json:"eui,omitempty"`
}
...
func NewPopulatedGatewayIdentifiers(r randyIdentifiers, easy bool) *GatewayIdentifiers {
	...
	this.EUI = github_com_TheThingsNetwork_ttn_pkg_types.NewPopulatedEUI64(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
var fileDescriptorIdentifiers = []byte{
	...
	,
}
