...
func (*SearchEntitiesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_search_services_18c7900f4b7285ea, []int{0}
}
...
func (*SearchEndDevicesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_search_services_18c7900f4b7285ea, []int{1}
}
...
func init() {
	proto.RegisterFile("lorawan-stack/api/search_services.proto", fileDescriptor_search_services_18c7900f4b7285ea)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/search_services.proto", fileDescriptor_search_services_18c7900f4b7285ea)
}

var fileDescriptor_search_services_18c7900f4b7285ea = []byte{
	// 1001 bytes of a gzipped FileDescriptorProto
	,
}
