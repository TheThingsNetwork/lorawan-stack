...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_0791c5e00a777515, []int{0}
}
...
type StreamEventsRequest struct {
	CombinedIdentifiers `protobuf:"bytes,1,opt,name=identifiers,embedded=identifiers" json:"identifiers"`
...
func (*StreamEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_0791c5e00a777515, []int{1}
}
...
func (this *StreamEventsRequest) Equal(that interface{}) bool {
	...
	if !this.CombinedIdentifiers.Equal(&that1.CombinedIdentifiers) {
		return false
	}
...
func (m *StreamEventsRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintEvents(dAtA, i, uint64(m.CombinedIdentifiers.Size()))
	n4, err := m.CombinedIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (this *StreamEventsRequest) String() string {
	...
	s := strings.Join([]string{`&StreamEventsRequest{`,
		`CombinedIdentifiers:` + strings.Replace(strings.Replace(this.CombinedIdentifiers.String(), "CombinedIdentifiers", "CombinedIdentifiers", 1), `&`, ``, 1) + `,`,
...
func (m *StreamEventsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CombinedIdentifiers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CombinedIdentifiers.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func init() {
	proto.RegisterFile("lorawan-stack/api/events.proto", fileDescriptor_events_0791c5e00a777515)
}
func init() {
	golang_proto.RegisterFile("lorawan-stack/api/events.proto", fileDescriptor_events_0791c5e00a777515)
}

var fileDescriptor_events_0791c5e00a777515 = []byte{
	// 631 bytes of a gzipped FileDescriptorProto
	,
}
