...
var as923RP2101Band = func(id string, offset as923GroupOffset) Band {
	return Band{
		...
		DataRates: map[ttnpb.DataRateIndex]DataRate{
			...
			ttnpb.DataRateIndex_DATA_RATE_2: makeLoRaDataRate(10, 125000, CR_4_5, makeDwellTimeMaxMACPayloadSizeFunc(123, 19)),
			...
			ttnpb.DataRateIndex_DATA_RATE_6: makeLoRaDataRate(7, 250000, CR_4_5, makeDwellTimeMaxMACPayloadSizeFunc(250, 250)),
