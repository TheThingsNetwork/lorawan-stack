...
var structValues = []struct {
...
}{
	{
		...
		map[string]interface{}{
			...
			"SubStruct.SubSubStruct.Interface":    mustToBytes(nil),
			"SubStruct.SubSubStruct.String":       string("42"),
			"SubStructPtr.ByteArray":              mustToBytes(byteArray{}),
			"SubStructPtr.Bytes":                  mustToBytes(nil),
			"SubStructPtr.Empty":                  mustToBytes(nil),
			"SubStructPtr.Int":                    int(42),
			"SubStructPtr.Interface":              mustToBytes(nil),
			"SubStructPtr.String":                 string("42"),
			"SubStructPtr.SubSubStruct.ByteArray": mustToBytes(byteArray{}),
			"SubStructPtr.SubSubStruct.Bytes":     mustToBytes(nil),
			"SubStructPtr.SubSubStruct.Empty":     mustToBytes(nil),
			"SubStructPtr.SubSubStruct.Int":       int(0),
			"SubStructPtr.SubSubStruct.Interface": mustToBytes(nil),
